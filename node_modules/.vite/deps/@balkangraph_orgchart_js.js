...
// node_modules/@balkangraph/orgchart.js/orgchart.js
var require_orgchart = __commonJS({
  "node_modules/@balkangraph/orgchart.js/orgchart.js"(exports, module) {
    var OrgChart = function(t, e) {
      var r = this;
      if (("string" == typeof t || t instanceof String) && (t = document.querySelector(t)), this.element = t, this.config = OrgChart.mergeDeep(OrgChart._defaultConfig(e), e), this._layoutConfigs = { base: { orientation: this.config.orientation, levelSeparation: this.config.levelSeparation, mixedHierarchyNodesSeparation: this.config.mixedHierarchyNodesSeparation, assistantSeparation: this.config.assistantSeparation, subtreeSeparation: this.config.subtreeSeparation, siblingSeparation: this.config.siblingSeparation, layout: this.config.layout, columns: this.config.columns, collapse: this.config.collapse, partnerNodeSeparation: this.config.partnerNodeSeparation } }, this.config.tags)
        for (var i in this.config.tags) {
          var a = this.config.tags[i];
          null != a.subTreeConfig && (this._layoutConfigs[i] = { orientation: null != a.subTreeConfig.orientation ? a.subTreeConfig.orientation : this.config.orientation, levelSeparation: null != a.subTreeConfig.levelSeparation ? a.subTreeConfig.levelSeparation : this.config.levelSeparation, mixedHierarchyNodesSeparation: null != a.subTreeConfig.mixedHierarchyNodesSeparation ? a.subTreeConfig.mixedHierarchyNodesSeparation : this.config.mixedHierarchyNodesSeparation, assistantSeparation: null != a.subTreeConfig.assistantSeparation ? a.subTreeConfig.assistantSeparation : this.config.assistantSeparation, subtreeSeparation: null != a.subTreeConfig.subtreeSeparation ? a.subTreeConfig.subtreeSeparation : this.config.subtreeSeparation, siblingSeparation: null != a.subTreeConfig.siblingSeparation ? a.subTreeConfig.siblingSeparation : this.config.siblingSeparation, layout: null != a.subTreeConfig.layout ? a.subTreeConfig.layout : this.config.layout, columns: null != a.subTreeConfig.columns ? a.subTreeConfig.columns : this.config.columns, collapse: null != a.subTreeConfig.collapse ? a.subTreeConfig.collapse : this.config.collapse, partnerNodeSeparation: null != a.subTreeConfig.partnerNodeSeparation ? a.subTreeConfig.partnerNodeSeparation : this.config.partnerNodeSeparation });
        }
      this._event_id = OrgChart._guid(), OrgChart._validateConfig(this.config) && (this._vScroll = {}, this.config.ui || (this.ui = OrgChart.ui), this.config.editUI ? this.editUI = this.config.editUI : this.editUI = new OrgChart.editUI(), this.editUI.init(this), this.config.filterUI ? this.filterUI = this.config.filterUI : this.filterUI = new OrgChart.filterUI(), this.filterUI.init(this), this.manager = new OrgChart.manager(this), this.config.searchUI ? this.searchUI = this.config.searchUI : this.searchUI = new OrgChart.searchUI(), this.config.nodeMenuUI ? this.nodeMenuUI = this.config.nodeMenuUI : this.nodeMenuUI = new OrgChart.menuUI(), this.nodeMenuUI.init(this, this.config.nodeMenu), this.config.nodeCircleMenuUI ? this.nodeCircleMenuUI = this.config.nodeCircleMenuUI : this.nodeCircleMenuUI = new OrgChart.circleMenuUI(), this.nodeCircleMenuUI.init(this, this.config.nodeCircleMenu), this.config.nodeContextMenuUI ? this.nodeContextMenuUI = this.config.nodeContextMenuUI : this.nodeContextMenuUI = new OrgChart.menuUI(), this.nodeContextMenuUI.init(this, this.config.nodeContextMenu), this.config.toolbarUI ? this.toolbarUI = this.config.toolbarUI : this.toolbarUI = new OrgChart.toolbarUI(), this.config.notifierUI ? this.notifierUI = this.config.notifierUI : this.notifierUI = new OrgChart.notifierUI(), this.notifierUI.init(this), this.config.menuUI ? this.menuUI = this.config.menuUI : this.menuUI = new OrgChart.menuUI(), this.menuUI.init(this, this.config.menu), this.config.xScrollUI || (this.xScrollUI = new OrgChart.xScrollUI(this.element, this.config, function() {
        ...
        r._draw(true, OrgChart.action.xScroll);
        ...
        r._draw(true, OrgChart.action.xScroll);
      })), this.element.classList.add("boc-" + this.config.mode), this._gragStartedId = null, this._timeout = null, this._touch = null, this._initialized = false, this._loaded = false, this._moveInterval = null, this._movePosition = null, this.response = null, this.nodes = null, this.isVisible = null, OrgChart._intersectionObserver(this.element, function(t2) {
        r.isVisible = t2, false !== OrgChart.events.publish("visibility-change", [r]) && OrgChart.LAZY_LOADING && r.isVisible && (r._loaded ? r._draw(false, OrgChart.action.update) : (r._setInitialSizeIfNotSet(), r._draw(false, OrgChart.action.init)));
      }));
    };
    OrgChart._defaultConfig = function(t) {
      return { interactive: true, mode: "light", lazyLoading: true, enableDragDrop: false, enableSearch: true, enableTouch: false, enablePan: true, keyNavigation: false, miniMap: false, nodeMenu: null, nodeCircleMenu: null, nodeContextMenu: null, menu: null, toolbar: false, sticky: true, nodeMouseClick: OrgChart.action.details, nodeMouseDbClick: OrgChart.none, mouseScrool: OrgChart.action.zoom, showXScroll: OrgChart.none, showYScroll: OrgChart.none, template: "ana", tags: {}, min: false, nodeBinding: {}, linkBinding: {}, searchFields: null, searchDisplayField: null, searchFieldsWeight: null, searchFieldsAbbreviation: null, nodes: [], clinks: [], slinks: [], groupDottedLines: [], dottedLines: [], levelSeparation: 60, siblingSeparation: 20, subtreeSeparation: 40, mixedHierarchyNodesSeparation: 15, assistantSeparation: 100, minPartnerSeparation: 50, partnerChildrenSplitSeparation: 20, partnerNodeSeparation: 15, columns: 10, padding: 30, orientation: OrgChart.orientation.top, layout: OrgChart.normal, scaleInitial: 1, scaleMin: 0.1, scaleMax: 5, orderBy: null, editUI: null, filterUI: null, searchUI: null, xScrollUI: null, yScrollUI: null, nodeMenuUI: null, nodeCircleMenuUI: null, nodeContextMenuUI: null, toolbarUI: null, notifierUI: null, menuUI: null, exportUrl: "https://balkan.app/export", collapse: {}, expand: {}, align: OrgChart.CENTER, UI: null, anim: { func: OrgChart.anim.outPow, duration: 200 }, zoom: { speed: 120, smooth: 12 }, roots: null, state: null, editForm: { readOnly: false, titleBinding: "name", photoBinding: "img", addMore: "Add more fields", addMoreBtn: "Add", addMoreFieldName: "Field name", saveAndCloseBtn: "Save and close", cancelBtn: "Cancel", generateElementsFromFields: true, focusBinding: null, buttons: { edit: { icon: OrgChart.icon.edit(24, 24, "#fff"), text: "Edit", hideIfEditMode: true, hideIfDetailsMode: false }, share: { icon: OrgChart.icon.share(24, 24, "#fff"), text: "Share" }, pdf: { icon: OrgChart.icon.pdf(24, 24, "#fff"), text: "Save as PDF" }, remove: { icon: OrgChart.icon.remove(24, 24, "#fff"), text: "Remove", hideIfDetailsMode: true } }, elements: [] } };
    }, OrgChart.prototype.load = function(t) {
      var e = this;
      return this.config.nodes = t, this._draw(false, OrgChart.action.init, void 0, function() {
        e.filterUI.update();
      }), this;
      ...
      null == t && (t = OrgChart.action.update), this._draw(false, t, e, r);
      ...
      if (!OrgChart.LAZY_LOADING || this.isVisible)
        if (OrgChart.LAZY_LOADING || this._initialized || (this._setInitialSizeIfNotSet(), 0 != this.width() && 0 != this.height())) {
          ...
          this.manager.read(t, this.width(), this.height(), n, e, r, function(t2) {
            if (!a.notifierUI.show(t2.notif)) {
              e != OrgChart.action.exporting && (a.nodes = t2.nodes, a.visibleNodeIds = t2.visibleNodeIds, a.roots = t2.roots), a.editUI.fields = t2.allFields;
              var n2 = { defs: "" };
              OrgChart.events.publish("renderdefs", [a, n2]);
              var o = a.ui.defs(n2.defs), l = a.getScale(t2.viewBox);
              o += a.ui.pointer(a.config, e, l);
              var s = a.getViewBox(), h = t2.viewBox;
              n2 = { content: o, res: t2 };
              OrgChart.events.publish("prerender", [a, n2]), o = n2.content;
              for (var d = 0; d < t2.visibleNodeIds.length; d++) {
                var c = t2.nodes[t2.visibleNodeIds[d]], g = a._get(c.id);
                OrgChart.RENDER_LINKS_BEFORE_NODES && (o += a.ui.link(c, a, l, t2.bordersByRootIdAndLevel, t2.nodes, e)), o += a.ui.node(c, g, t2.animations, a.config, void 0, void 0, void 0, e, l, a);
              }
              for (d = 0; d < t2.visibleNodeIds.length; d++) {
                c = t2.nodes[t2.visibleNodeIds[d]];
                OrgChart.RENDER_LINKS_BEFORE_NODES || (o += a.ui.link(c, a, l, t2.bordersByRootIdAndLevel, t2.nodes, e)), o += a.ui.expandCollapseBtn(a, c, a._layoutConfigs, e, l);
              }
              n2 = { content: o, res: t2 };
              if (OrgChart.events.publish("render", [a, n2]), o = n2.content, t2 = n2.res, o += a.ui.lonely(a.config), e !== OrgChart.action.exporting) {
                e !== OrgChart.action.centerNode && e !== OrgChart.action.insert && e !== OrgChart.action.expand && e !== OrgChart.action.collapse && e !== OrgChart.action.update || (h = s), e === OrgChart.action.init && null != s && (h = s), a.response = t2;
                ...
                var f = false, m = a.response.animations;
                if (m[0].length > 0) {
                  ...
                  OrgChart.animate(m[0], m[1], m[2], a.config.anim.duration, a.config.anim.func, function() {
                    f || (i && i(), OrgChart.events.publish("redraw", [a]), a._showAfterAnimation(), f = true);
                  });
                }
                e === OrgChart.action.centerNode ? OrgChart.animate(a.getSvg(), { viewbox: s }, { viewbox: a.response.viewBox }, a.config.anim.duration, a.config.anim.func, function() {
                  a.ripple(r.options.rippleId), f || (i && i(), OrgChart.events.publish("redraw", [a]), a._showAfterAnimation(), f = true);
                }, function() {
                  a.xScrollUI.setPosition(), a.yScrollUI.setPosition();
                }) : !s || !a.response || s[0] == a.response.viewBox[0] && s[1] == a.response.viewBox[1] && s[2] == a.response.viewBox[2] && s[3] == a.response.viewBox[3] || e !== OrgChart.action.insert && e !== OrgChart.action.expand && e !== OrgChart.action.collapse && e !== OrgChart.action.update && e !== OrgChart.action.init ? 0 == m[0].length && (f || (i && i(), OrgChart.events.publish("redraw", [a]), f = true)) : OrgChart.animate(a.getSvg(), { viewbox: s }, { viewbox: a.response.viewBox }, 2 * a.config.anim.duration, a.config.anim.func, function() {
                  a.xScrollUI.setPosition(), a.yScrollUI.setPosition(), f || (i && i(), OrgChart.events.publish("redraw", [a]), f = true);
                }), a._initialized || (a._initialized = true, a.filterUI.update(), OrgChart.events.publish("init", [a])), !a._loaded && t2 && t2.nodes && Object.keys(t2.nodes).length && (a._loaded = true);
              } else {
                var C = t2.boundary, b = C.maxX - C.minX, O = C.maxY - C.minY, v = a.ui.svg(b, O, [C.minX, C.minY, b, O], a.config, o, l);
                i(v);
              }
            }
          }, function(t2) {
            OrgChart.events.publish("ready", [a, t2]);
          });
        } else
      ...
      if (null != i) {
        ...
        if (null != a) {
          ...
          var h = i.w, d = i.h, c = h - o > o ? h - o : o, g = d - l > l ? d - l : l, p = c > g ? c : g, u = document.createElementNS("http://www.w3.org/2000/svg", "g"), f = document.createElementNS("http://www.w3.org/2000/svg", "clipPath"), m = document.createElementNS("http://www.w3.org/2000/svg", "rect"), C = document.createElementNS("http://www.w3.org/2000/svg", "circle"), b = OrgChart.randomId();
          f.setAttribute("id", b);
          var O = { ripple: OrgChart.t(i.templateName, i.min, this.getScale()).ripple, node: i };
          OrgChart.events.publish("ripple", [this, O]), m.setAttribute("x", O.ripple.rect ? O.ripple.rect.x : 0), m.setAttribute("y", O.ripple.rect ? O.ripple.rect.y : 0), m.setAttribute("width", O.ripple.rect ? O.ripple.rect.width : i.w), m.setAttribute("height", O.ripple.rect ? O.ripple.rect.height : i.h), m.setAttribute("rx", O.ripple.radius), m.setAttribute("ry", O.ripple.radius), C.setAttribute("clip-path", "url(#" + b + ")"), C.setAttribute("cx", o), C.setAttribute("cy", l), C.setAttribute("r", 0), C.setAttribute("fill", O.ripple.color), C.setAttribute("class", "boc-ripple"), f.appendChild(m), u.appendChild(f), u.appendChild(C), a.appendChild(u), OrgChart.animate(C, { r: 0, opacity: 1 }, { r: p, opacity: 0 }, 500, OrgChart.anim.outPow, function() {
            a.removeChild(u);
          });
        }
      }
    }, OrgChart.prototype.center = function(t, e, r) {
      var i, a, n = t, o = true, l = true;
      ...
      this._draw(false, OrgChart.action.centerNode, { id: t, options: s }, r);
    }, OrgChart.prototype.fit = function(t) {
      this.config.scaleInitial = OrgChart.match.boundary, this._draw(true, OrgChart.action.init, { method: "fit" }, t);
      ...
      e || (e = "base"), this._layoutConfigs[e].layout = t, this._draw(false, OrgChart.action.update);
    }, OrgChart.prototype.setOrientation = function(t, e) {
      e || (e = "base"), this._layoutConfigs[e].orientation = t, this._draw(false, OrgChart.action.update);
      ...
      if (e) {
        ...
        (e = new Date()).setDate(e.getDate() + 5), e = e.toISOString(), localStorage.setItem("to_date", e);
      return localStorage.getItem(t);
    }, OrgChart.localStorage.setItem = function(t, e) {
      try {
        localStorage.setItem(t, e);
      } catch (t2) {
        t2.code == t2.QUOTA_EXCEEDED_ERR ? (console.warn("Local storage quota exceeded"), localStorage.clear()) : (console.error("Local storage error code:" + t2.code), console.error(t2));
      }
      ...
      if (true === r && false === OrgChart.events.publish("update", [this, a, t]))
        return false;
      this.update(t);
      var n = this.getNode(t.id), o = n.pid;
      null == o && (o = n.stpid), this._draw(false, OrgChart.action.update, { id: o }, function() {
      ...
      if (true === r && false === OrgChart.events.publish("remove", [this, t, a]))
        return false;
      return this.remove(t), this._draw(false, OrgChart.action.update, null, function() {
      ...
      var i = this;
      if (true === r && false === OrgChart.events.publish("add", [this, t]))
        return false;
      this.add(t), i._draw(false, OrgChart.action.insert, { id: t.pid, insertedNodeId: t.id }, function() {
      ...
      n.onload = function(t2) {
        4 == n.readyState && 200 === this.status && (null == t2.target ? a(this.response) : a(t2.target.response));
      }, n.onerror = function(t2) {
        a({ error: t2 });
        ...
        for (var c = 0; c < t.length; c++)
          for (var g in r[c]) {
            ...
            switch (g.toLowerCase()) {
              case "d":
                var u = a((h * s - s) / i) * (r[c][g][0] - e[c][g][0]) + e[c][g][0], f = a((h * s - s) / i) * (r[c][g][1] - e[c][g][1]) + e[c][g][1];
      ...
      return t < 0 ? 0 : t > 1 ? 1 : t < 1 / 2.75 ? 1 - 7.5625 * t * t : t < 2 / 2.75 ? 1 - (7.5625 * (t - 1.5 / 2.75) * (t - 1.5 / 2.75) + 0.75) : t < 2.5 / 2.75 ? 1 - (7.5625 * (t - 2.25 / 2.75) * (t - 2.25 / 2.75) + 0.9375) : 1 - (7.5625 * (t - 2.625 / 2.75) * (t - 2.625 / 2.75) + 0.984375);
      ...
      if (this.hide(), false === OrgChart.events.publish("show", [this, t]))
        return false;
      var i = this, a = this.content(t, e, r);
      this.obj.element.appendChild(a.element), OrgChart.input.init(this.obj.element), r ? e || this._focusElement(a.focusId) : this.interval = OrgChart.animate(a.element, { right: -20, opacity: 0 }, { right: 0, opacity: 1 }, 300, OrgChart.anim.outSin, function() {
        e || i._focusElement(a.focusId);
      }), this.obj.element.querySelector("[data-edit-from-close]").addEventListener("click", function(e2) {
        e2.preventDefault(), false !== OrgChart.events.publish("cancel", [i, { id: t }]) && i.hide();
      }), this.obj.element.querySelector("[data-edit-from-cancel]").addEventListener("click", function(e2) {
        e2.preventDefault(), false !== OrgChart.events.publish("cancel", [i, { id: t }]) && i.hide();
      }), this.obj.element.querySelector("[data-edit-from-save]").addEventListener("click", function(e2) {
        e2.preventDefault();
        var r2 = OrgChart.input.validateAndGetData(a.element);
        if (false !== r2) {
          var n2 = i.obj.get(t), o2 = { data: OrgChart.mergeDeep(n2, r2) };
          if (false === OrgChart.events.publish("save", [i, o2]))
            return;
          i.obj.updateNode(o2.data, null, true), i.hide();
        }
      });
      for (var n = this.obj.element.querySelectorAll("[data-input-btn]"), o = 0; o < n.length; o++) {
        n[o].addEventListener("click", function(e2) {
          e2.preventDefault(), OrgChart.events.publish("element-btn-click", [i, { input: this.parentNode.querySelector("input"), nodeId: t, event: e2 }]);
        });
      }
      this.obj.element.querySelector("[data-add-more-fields-btn]").addEventListener("click", function(t2) {
        t2.stopPropagation(), t2.preventDefault();
        var e2 = this, r2 = OrgChart.elements.textbox({}, { type: "textbox", label: i.obj.config.editForm.addMoreFieldName, btn: i.obj.config.editForm.addMoreBtn }, "280px");
        e2.parentNode.insertAdjacentHTML("beforebegin", r2.html), e2.style.display = "none", OrgChart.input.init(e2.parentNode.previousSibling);
        var a2 = document.getElementById(r2.id);
        a2.focus(), a2.nextElementSibling.addEventListener("click", function(t3) {
          t3.stopPropagation(), t3.preventDefault();
          var r3 = a2.value, n2 = i.obj.element.querySelector('[data-binding="' + OrgChart._escapeDoubleQuotes(a2.value) + '"]');
          if (OrgChart.isNEU(r3) || n2)
            a2.focus();
          else {
            var o2 = OrgChart.elements.textbox({}, { type: "textbox", label: r3, binding: r3 }, "280px");
            a2.parentNode.parentNode.parentNode.removeChild(a2.parentNode.parentNode), e2.parentNode.insertAdjacentHTML("beforebegin", o2.html), e2.style.display = "", OrgChart.input.init(e2.parentNode.previousSibling), document.getElementById(o2.id).focus();
          }
        });
      }), this.obj.element.querySelector("[data-boc-edit-from-btns]").addEventListener("click", function(e2) {
        for (var r2 = e2.target; r2 && r2.hasAttribute && !r2.hasAttribute("data-edit-from-btn"); )
          r2 = r2.parentNode;
        if (r2 && r2.hasAttribute) {
          var n2 = r2.getAttribute("data-edit-from-btn"), o2 = { button: i.obj.config.editForm.buttons[n2], name: n2, nodeId: t, event: e2 };
          if (false === OrgChart.events.publish("button-click", [i, o2]))
            return false;
          switch (n2) {
            case "edit":
              i.obj.editUI.show(t, false, true);
              break;
            case "pdf":
            ...
            case "share":
              ...
              break;
            case "remove":
              i.obj.removeNode(t, null, true), i.hide();
          }
        }
      });
      ...
      var w = !e, k = e ? "display:none;" : "", S = e || !s ? "display:none;" : "", I = m.editFormHeaderColor ? `style="background-color:${m.editFormHeaderColor};"` : "", A = document.createElement("form");
      if (A.setAttribute("data-boc-edit-form", ""), A.classList.add("boc-edit-form"), A.classList.add(this.obj.config.mode), A.classList.add(u.templateName), A.classList.add(OrgChart.ui._defsIds[u.templateName]), Array.isArray(u.tags) && u.tags.length)
        for (O = 0; O < u.tags.length; O++)
          A.classList.add(u.tags[O]);
      A.style.display = "flex", A.style.opacity = r ? 1 : 0, A.style.right = r ? 0 : "-20px", i && (A.style.width = i);
      var E = [], L = a ? "" : OrgChart.EDITFORM_CLOSE_BTN;
      return A.innerHTML = `<div>
        ...
        for (var r2 in c) {
          var i2 = c[r2];
          OrgChart.isNEU(i2) || (w && i2.hideIfEditMode || e && i2.hideIfDetailsMode || o && "Edit" == i2.text || (t2 += `<div data-edit-from-btn='${r2}' class="boc-img-button" ${I} title="${i2.text}">${i2.icon}</div>`));
        }
        return t2;
      }()}    
                        </div>
                    ...
                    <div class="boc-edit-form-fields">
                        <div class="boc-edit-form-fields-inner">
                            <div class="boc-form-fieldset">
                                ${function() {
        for (var t2 = "", r2 = 0; r2 < l.length; r2++) {
          var i2 = l[r2];
          if (Array.isArray(i2)) {
            t2 += '<div class="boc-form-field-100 boc-form-fieldset">';
            for (var a2 = 0; a2 < i2.length; a2++) {
              var o2 = i2[a2], s2 = OrgChart.elements[o2.type](f, o2, "unset", e);
              !OrgChart.isNEU(s2.id) && OrgChart.isNEU(n) && OrgChart.isNEU(s2.value) && (n = s2.id), OrgChart.isNEU(s2.value) || E.push(`${o2.label}: ${s2.value}`), t2 += s2.html;
            }
            t2 += "</div>";
          } else {
            s2 = OrgChart.elements[i2.type](f, i2, "280px", e);
            !OrgChart.isNEU(s2.id) && OrgChart.isNEU(n) && OrgChart.isNEU(s2.value) && (n = s2.id), OrgChart.isNEU(s2.value) || E.push(`${i2.label}: ${s2.value}`), t2 += s2.html;
          }
        }
        return t2;
      }()}
                    ...
                    </div>`, { element: A, focusId: n, title: C, shareText: E.join("\n") };
    }, OrgChart.editUI.prototype.hide = function() {
      if (false === OrgChart.events.publish("hide", [this]))
        return false;
      ...
      if (false === OrgChart.events.publish("show", [this, l]))
        return false;
      ...
      if ("" != o) {
        ...
        for (var u = this.wrapper.getElementsByTagName("div"), f = 0; f < u.length; f++) {
          (s = u[f]).addEventListener("click", function(t2) {
            var e2, o2 = this.getAttribute(OrgChart.attr.item);
            if (void 0 === a[o2].onClick)
              if ("add" === o2) {
                var l2 = { id: n.obj.generateId(), pid: r };
                n.obj.addNode(l2, null, true);
              } else if ("edit" === o2) {
                var s2 = n.obj.getNode(r);
                n.obj.editUI.show(s2.id);
              } else if ("details" === o2) {
                s2 = n.obj.getNode(r);
                n.obj.editUI.show(s2.id, true);
              } else
                "remove" === o2 ? n.obj.removeNode(r, null, true) : "svg" === o2 ? n.obj.exportSVG({ filename: "OrgChart.svg", expandChildren: false, nodeId: r }) : "pdf" === o2 ? n.obj.exportPDF({ filename: "OrgChart.pdf", expandChildren: false, nodeId: r }) : "png" === o2 ? n.obj.exportPNG({ filename: "OrgChart.png", expandChildren: false, nodeId: r }) : "csv" === o2 ? n.obj.exportCSV() : "xml" === o2 ? n.obj.exportXML() : "json" === o2 && n.obj.exportJSON();
            else
              e2 = a[o2].onClick.call(n.obj, r, i);
            0 != e2 && n.hide();
          });
        }
      }
        ...
        if (OrgChart.isNEU(p) || p.getAttribute(OrgChart.attr.control_node_circle_menu_wrraper_id) != t) {
          ...
          for (var x in (p = document.createElementNS("http://www.w3.org/2000/svg", "g")).setAttribute(OrgChart.attr.control_node_circle_menu_wrraper_id, t), p.setAttribute("transform", "matrix(1,0,0,1," + d + "," + c + ")"), n.appendChild(p), u.menu) {
            ...
            if (A.setAttribute("pointer-events", "none"), A) {
              var E = parseInt(A.getAttribute("width")), L = parseInt(A.getAttribute("height"));
              A.setAttribute("x", -E / 2), A.setAttribute("y", -L / 2);
            }
            var N = m * Math.PI / (C / 2);
            m++;
            var M = Math.cos(N) * b, T = Math.sin(N) * b;
            this._buttonsInterval.push(OrgChart.animate(k, { transform: [1, 0, 0, 1, 0, 0] }, { transform: [1, 0, 0, 1, M, T] }, 250, OrgChart.anim.outBack, function(t2) {
              var e2 = t2[0].getAttribute(OrgChart.attr.control_node_circle_menu_name), i2 = t2[0].parentNode.getAttribute(OrgChart.attr.control_node_circle_menu_wrraper_id);
              t2[0].addEventListener("mouseenter", function(t3) {
                OrgChart.events.publish("mouseenter", [r, { from: i2, menuItem: u.menu[e2], menuItemName: e2, event: t3 }]);
              }), t2[0].addEventListener("mouseout", function(t3) {
                OrgChart.events.publish("mouseout", [r, { from: i2, menuItem: u.menu[e2], menuItemName: e2, event: t3 }]);
              });
            }));
          }
          this._linesInterval.push(OrgChart.animate(g[0], { x1: -a.nodeCircleMenuButton.radius / 2, y1: -6, x2: a.nodeCircleMenuButton.radius / 2, y2: -6 }, { x1: -7, y1: -7, x2: 7, y2: 7 }, 500, OrgChart.anim.inOutSin)), this._linesInterval.push(OrgChart.animate(g[1], { x1: -a.nodeCircleMenuButton.radius / 2, y1: 0, x2: a.nodeCircleMenuButton.radius / 2, y2: 0 }, { x1: 0, y1: 0, x2: 0, y2: 0 }, 500, OrgChart.anim.inOutSin)), this._linesInterval.push(OrgChart.animate(g[2], { x1: -a.nodeCircleMenuButton.radius / 2, y1: 6, x2: a.nodeCircleMenuButton.radius / 2, y2: 6 }, { x1: -7, y1: 7, x2: 7, y2: -7 }, 500, OrgChart.anim.inOutSin));
        } else
          this.hide();
      }
      ...
      if (null != e) {
        var r = e.getAttribute(OrgChart.attr.control_node_circle_menu_wrraper_id), i = this.obj.getNode(r), a = OrgChart.t(i.templateName, i.min, this.obj.getScale()), n = this.obj.element.querySelector("[" + OrgChart.attr.control_node_circle_menu_id + '="' + r + '"]').querySelectorAll("line");
      ...
      return OrgChart.events.on(t, e, this._event_id), this;
    }, void 0 === OrgChart && (OrgChart = {}), OrgChart.idb = { version: 1, dbName: "BALKAN", tableName: "orgchart-js", keyPath: "id" }, OrgChart.idb.db = null, OrgChart.idb._open = function(t) {
      if (OrgChart._browser().msie)
        ...
        if (!window.indexedDB)
          return console.error("Your browser doesn't support a stable version of IndexedDB."), void (t && t(false));
        if (null == OrgChart.idb.db) {
          var e = indexedDB.open(OrgChart.idb.dbName, OrgChart.idb.version);
          e.onerror = function(e2) {
            console.error("Cannot open database!"), t && t(false);
          }, e.onsuccess = function(e2) {
            OrgChart.idb.db = e2.target.result, t && t(true);
          }, e.onupgradeneeded = function(t2) {
            var e2 = t2.target.result;
            e2.objectStoreNames.contains(OrgChart.idb.tableName) && e2.deleteObjectStore(OrgChart.idb.tableName);
            e2.createObjectStore(OrgChart.idb.tableName, { keyPath: OrgChart.idb.keyPath });
          };
        } else
          t && t(true);
      }
      ...
      OrgChart.idb._open(function(r) {
        if (r) {
          ...
          i.onerror = function(t2) {
            console.error("Unable to retrieve data from database!"), e && e(false);
          }, i.onsuccess = function(t2) {
            i.result ? e && e(true, i.result) : e && e(null);
          };
        } else
          e && e(false);
      });
      ...
      OrgChart.idb.read(t.id, function(r) {
        if (null == r) {
          ...
          i.onerror = function(t2) {
            console.error("Unable to add data to database!"), e && e(false);
          }, i.onsuccess = function(t2) {
            e && e(true);
          };
        } else
      ...
      OrgChart.idb._open(function(r) {
        if (r) {
          ...
          i.onerror = function(t2) {
            console.error("Unable to put data to database!"), e && e(false);
          }, i.onsuccess = function(t2) {
            e && e(true);
          };
        } else
      ...
      if (e) {
        ...
        }), this.layouts && this.layouts.addEventListener("click", function(t2) {
          for (var e2 = t2.target; e2; ) {
            if (e2.hasAttribute && e2.hasAttribute(OrgChart.attr.layout)) {
              e2 = e2.getAttribute(OrgChart.attr.layout), l.obj.setLayout(OrgChart[e2]);
              break;
            }
            e2 = e2.parentNode;
          }
      ...
      this._visible = true, this.layoutBtn.style.transform = "rotate(180deg) translateX(0px) translateY(0px)", OrgChart.animate(this.div, { bottom: this.obj.config.padding - 10 }, { bottom: this.obj.config.padding + 135 }, this.obj.config.anim.duration, this.obj.config.anim.func), OrgChart.animate(this.layouts, { bottom: -145 }, { bottom: 0 }, this.obj.config.anim.duration, this.obj.config.anim.func);
    }, OrgChart.toolbarUI.prototype.hideLayout = function() {
      this._visible = false, this.layoutBtn.style.transform = "rotate(0deg) translateX(0px) translateY(0px)", OrgChart.animate(this.div, { bottom: this.obj.config.padding + 135 }, { bottom: this.obj.config.padding - 10 }, this.obj.config.anim.duration, this.obj.config.anim.func), OrgChart.animate(this.layouts, { bottom: 0 }, { bottom: -145 }, this.obj.config.anim.duration, this.obj.config.anim.func);
      ...
      var n = r.offsetWidth;
      return r.style.width = "20px", OrgChart.animate(r, { opacity: 0, width: 10 }, { opacity: 1, width: n }, this.obj.config.anim.duration, this.obj.config.anim.func), true;
    ...
    <path fill="${r}" d="m256 0c-141.49 0-256 114.5-256 256 0 141.49 114.5 256 256 256 141.49 0 256-114.5 256-256 0-141.49-114.5-256-256-256zm-12.284 317.397-58.121 58.132c-6.565 6.553-15.283 10.166-24.557 10.166-19.196 0-34.734-15.526-34.734-34.734 0-9.274 3.612-17.992 10.166-24.557l58.132-58.121c6.785-6.784 6.785-17.783 0-24.568l-58.132-58.121c-6.553-6.565-10.166-15.283-10.166-24.557 0-19.196 15.526-34.734 34.734-34.734 9.274 0 17.992 3.613 24.557 10.166l58.121 58.132c6.785 6.773 17.784 6.773 24.568 0l58.121-58.132c6.565-6.553 15.283-10.166 24.557-10.166 19.196 0 34.734 15.526 34.734 34.734 0 9.274-3.612 17.992-10.166 24.557l-58.132 58.121c-6.785 6.784-6.785 17.783 0 24.568l58.132 58.121c6.553 6.565 10.166 15.283 10.166 24.557 0 19.196-15.526 34.734-34.734 34.734-9.274 0-17.992-3.613-24.557-10.166l-58.121-58.132c-6.784-6.784-17.784-6.773-24.568 0z"/>
      ...
      var e;
      "object" == typeof t ? t = (e = t).focusId : e = this.editUI.content(t, true, true, "100%", true);
      ...
      return null == t && (t = {}), "svg" == e ? (t.ext = "svg", t.mime = "image/svg+xml") : "pdf" == e ? (t.mime = "application/pdf", t.ext = "pdf") : "png" == e && (t.mime = "image/png", t.ext = "png"), null == t.margin && (t.margin = [50, 40, 50, 40]), null == t.padding && (t.padding = 0), null == t.landscape && (t.landscape = false), null == t.filename && (t.filename = "OrgChart." + t.ext), null == t.scale && (t.scale = "fit"), null == t.format && (t.format = "fit"), null == t.header && (t.header = ""), "pdf" == e && null == t.footer ? t.footer = "Page {current-page} of {total-pages}" : null == t.footer && (t.footer = ""), null == t.openInNewTab && (t.openInNewTab = false), null == t.mode && (t.mode = "boc-" + this.config.mode), t;
    }, OrgChart.prototype._export = function(t, e) {
      var r = this, i = { id: t.nodeId, expandChildren: t.expandChildren, min: t.min };
      t.margin && t.margin[0] < 2 && (t.margin[0] = 2), t.margin && t.margin[1] < 2 && (t.margin[1] = 2), t.margin && t.margin[2] < 2 && (t.margin[2] = 2), t.margin && t.margin[3] < 2 && (t.margin[3] = 2), this._draw(false, OrgChart.action.exporting, i, function(i2) {
        var a = document.createElement("div");
        if (a.innerHTML = i2, t.padding > 0) {
        ...
        if ("svg" == t.ext)
          if (e)
            ...
            var l = { content: a.innerHTML, options: t, styles: "" }, s = OrgChart.events.publish("exportstart", [r, l]), h = r.element.querySelector("[data-boc-styles]");
            if (h && (l.styles += h.outerHTML), l.styles && (a.childNodes[0].insertAdjacentHTML("afterbegin", l.styles), l.content = a.innerHTML), false === s)
              return false;
            if (false === (s = OrgChart.events.publish("exportend", [r, l])))
              return false;
            OrgChart._downloadFile(t.mime, l.content, l.options.filename, l.options.openInNewTab, l.options.ext);
          }
        else
          r._pages(t, a.querySelector("svg"), function(i3) {
            var n2 = { content: a.innerHTML, options: t, pages: i3, styles: "" }, o2 = OrgChart.events.publish("exportstart", [r, n2]), l2 = r.element.querySelector("[data-boc-styles]");
            if (l2 && (n2.styles += l2.outerHTML), false === o2)
              return false;
            e || OrgChart.loading.show(r), e ? e(r, n2, a.querySelector("svg")) : (n2 = JSON.stringify(n2), OrgChart._ajax(r.config.exportUrl + "/v3", "POST", n2, "arraybuffer", function(e2) {
              var i4 = OrgChart.events.publish("exportend", [r, e2]);
              if (OrgChart.loading.hide(r), false === i4)
                return false;
              OrgChart._downloadFile(t.mime, e2, t.filename, t.openInNewTab, t.ext);
            }));
          });
      });
      ...
      if (false === OrgChart.events.publish("exportstart", [this, e]))
        return false;
      var r = OrgChart._json2csv(e.nodes), i = { ext: e.ext, filename: e.filename, nodes: e.nodes, content: r };
      if (false === OrgChart.events.publish("exportend", [this, i]))
        return false;
      ...
      if (false === OrgChart.events.publish("exportend", [this, r]))
        return false;
      ...
      var r = e.getAttribute("width"), i = e.getAttribute("height"), a = OrgChart._getViewBox(e), n = { w: parseFloat(r), h: parseFloat(i) };
      ...
      var n = t.landscape ? a - (t.margin[1] + t.margin[3]) : i - (t.margin[1] + t.margin[3]), o = (t.landscape ? (t.margin[0], t.margin[2]) : (t.margin[0], t.margin[2]), n / r);
      ...
      var o = i[0], l = i[1], s = i[2], h = i[3], d = { w: t.landscape ? n - (t.margin[1] + t.margin[3]) : a - (t.margin[1] + t.margin[3]), h: t.landscape ? a - (t.margin[0] + t.margin[2]) : n - (t.margin[0] + t.margin[2]) }, c = { w: t.landscape ? n : a, h: t.landscape ? a : n };
      ...
      return (OrgChart.isNEU(t) || OrgChart.isNEU(t.id)) && console.error("options.id is not defilned"), "svg" == e ? (t.ext = "svg", t.mime = "image/svg+xml") : "pdf" == e ? (t.mime = "application/pdf", t.ext = "pdf") : "png" == e && (t.mime = "image/png", t.ext = "png"), null == t.margin && (t.margin = [50, 40, 50, 40]), null == t.padding && (t.padding = 0), null == t.landscape && (t.landscape = false), null == t.filename && (t.filename = "Profile." + t.ext), null == t.scale && (t.scale = "fit"), null == t.format && (t.format = "A4"), null == t.header && (t.header = ""), null == t.footer && (t.footer = ""), null == t.openInNewTab && (t.openInNewTab = false), null == t.mode && (t.mode = "boc-" + this.config.mode), t;
      ...
      var n = { w: t.landscape ? a - (t.margin[1] + t.margin[3]) : i - (t.margin[1] + t.margin[3]), h: t.landscape ? i - (t.margin[0] + t.margin[2]) : a - (t.margin[0] + t.margin[2]) }, o = { w: t.landscape ? a : i, h: t.landscape ? i : a }, l = this.editUI.content(t.id, true, true, "100%", true).element;
      OrgChart.input.init(l);
      var s = { content: l.outerHTML, options: t, pages: [{ vb: "", innerSize: n, size: o }], styles: "" };
      if (!e) {
        if (false === OrgChart.events.publish("exportstart", [r, s]))
          return false;
      ...
      s = JSON.stringify(s), OrgChart._ajax(this.config.exportUrl + "/v3", "POST", s, "arraybuffer", function(i2) {
        if (e)
          e(r, i2);
        else {
          var a2 = OrgChart.events.publish("exportend", [r, i2]);
          if (OrgChart.loading.hide(r), false === a2)
            return false;
          OrgChart._downloadFile(t.mime, i2, t.filename, t.openInNewTab, t.ext);
        }
      });
    }, void 0 === OrgChart && (OrgChart = {}), OrgChart.events = function() {
      var t = {};
      return { on: function(e, r, i) {
        ...
        if (t[e]) {
          ...
          if (i.length > 0) {
            var o = true;
            for (a = 0; a < i.length && (1 == r.length ? o = i[a](r[0]) && o : 2 == r.length ? o = i[a](r[0], r[1]) && o : 3 == r.length ? o = i[a](r[0], r[1], r[2]) && o : 4 == r.length ? o = i[a](r[0], r[1], r[2], r[3]) && o : 5 == r.length && (o = i[a](r[0], r[1], r[2], r[3], r[4]) && o), false !== o); a++)
              ;
            return o;
          }
        }
      ...
      e.setAttribute("type", "file"), e.setAttribute("accept", ".csv"), e.style.display = "none", e.onchange = function(e2) {
        var r = e2.target, i = new FileReader();
        i.onload = function() {
          var e3 = i.result, r2 = OrgChart._csvToArray(e3), a = [], n = r2[0];
          OrgChart._importSetColumnNames(n, function(e4) {
            for (var i2 = 1; i2 < r2.length; i2++) {
              for (var n2 = {}, o = 0; o < r2[i2].length; o++) {
                var l = e4[o], s = r2[i2][o];
                n2[l] = OrgChart._convertStringToArray(l, s);
              }
              "" != n2.id.trim() && a.push(n2);
            }
            var h = { nodes: a, columnNames: r2[0] };
      ...
      if (-1 == t.indexOf("id") || -1 == t.indexOf("pid")) {
        ...
        var a = document.createElement("div"), n = document.createElement("div"), o = document.createElement("div"), l = document.createElement("span");
        ...
        v.innerHTML = "Import", v.style.fontSize = "16px", v.style.color = "rgb(122, 122, 122)", v.style.padding = "5px 20px", v.style.margin = "20px auto", v.style.display = "block", v.onclick = function() {
          ...
          var r2 = g.options[g.selectedIndex].value, i2 = t.indexOf(r2);
          t[i2] = "id";
          var n2 = b.options[b.selectedIndex].value, o2 = t.indexOf(n2);
          t[o2] = "pid", e(t);
        };
        var x = document.createElement("DIV");
        return x.appendChild(v), r.appendChild(x), l.onclick = function(t2) {
          a._overlay && a._overlay.parentNode.removeChild(a._overlay), a.parentNode.removeChild(a), t2.stopPropagation();
        }, n.onmousedown = function(t2) {
          t2 = t2 || window.event, a._dragging = true, a._originalLeft = a.offsetLeft, a._originalTop = a.offsetTop, a._mouseLeft = t2.clientX, a._mouseTop = t2.clientY;
        }, document.onmousemove = function(t2) {
          t2 = t2 || window.event, a._dragging && (a.style.left = a._originalLeft + t2.clientX - a._mouseLeft + "px", a.style.top = a._originalTop + t2.clientY - a._mouseTop + "px");
        }, document.onmouseup = function(t2) {
          t2 = t2 || window.event, a._dragging && (a.style.left = a._originalLeft + t2.clientX - a._mouseLeft + "px", a.style.top = a._originalTop + t2.clientY - a._mouseTop + "px", a._dragging = false);
        }, a;
      }
      e(t);
      ...
      var t = this, e = document.createElement("INPUT");
      e.setAttribute("type", "file"), e.setAttribute("accept", ".xml"), e.style.display = "none", e.onchange = function(e2) {
        var r = e2.target, i = new FileReader();
        i.onload = function() {
          var e3 = i.result, r2 = OrgChart._xml2json(e3);
          0 != OrgChart.events.publish("import", [t, r2]) && (t.config.nodes = r2, t.draw());
        }, i.readAsText(r.files[0]);
      }, e.click();
    }, OrgChart.prototype.importJSON = function() {
      var t = this, e = document.createElement("INPUT");
      e.setAttribute("type", "file"), e.setAttribute("accept", ".json"), e.style.display = "none", e.onchange = function(e2) {
        var r = e2.target, i = new FileReader();
        i.onload = function() {
          var e3 = i.result, r2 = JSON.parse(e3);
          0 != OrgChart.events.publish("import", [t, r2]) && (t.config.nodes = r2, t.draw());
        }, i.readAsText(r.files[0]);
      }, e.click();
    }, OrgChart.prototype.expand = function(t, e, r) {
      var i = { id: t, ids: e };
      this._draw(false, OrgChart.action.expand, i, r);
    }, OrgChart.prototype.collapse = function(t, e, r) {
      var i = { id: t, ids: e };
      this._draw(false, OrgChart.action.collapse, i, r);
      ...
      this._draw(false, OrgChart.action.collapse, a, i);
    }, OrgChart.prototype.changeRoots = function(t, e, r) {
      this.config.roots = e;
      var i = { id: t, changeRoots: e };
      this._draw(false, OrgChart.action.update, i, r);
    }, OrgChart.prototype.maximize = function(t, e, r, i) {
      var a = this, n = { id: t, options: {} };
      OrgChart.isNEU(n.id) && (n.id = this.roots[0].id, n.all = true), n.options.horizontal = false, n.options.vertical = false, e && (n.options.horizontal = e), r && (n.options.vertical = r), this._draw(false, OrgChart.action.maximize, n, function() {
        a.ripple(t), i && i();
      });
    }, OrgChart.prototype.minimize = function(t, e) {
      var r = this, i = { id: t };
      OrgChart.isNEU(i.id) && (i.id = this.roots[0].id, i.all = true), this._draw(false, OrgChart.action.minimize, i, function() {
        r.ripple(t), e && e();
      });
      ...
      if (r.length) {
        if (false === OrgChart.events.publish("expcollclick", [this, false, t, r]))
          return false;
        this.expand(t, r, false);
      } else {
        if (false === OrgChart.events.publish("expcollclick", [this, true, t, e.childrenIds]))
          return false;
        this.collapse(t, e.childrenIds, false);
      }
    }, OrgChart.prototype._upHandler = function(t) {
      this.nodeMenuUI.hide(), this.nodeContextMenuUI.hide(), this.menuUI.hide(), this.nodeCircleMenuUI.hide();
      var e = this._upHandlerCreateArgs(t);
      if (false === OrgChart.events.publish("up-click", [this, e]))
        return false;
      this.changeRoots(e.id, e.roots, false);
    ...
    }), Array.prototype.unique || Object.defineProperty(Array.prototype, "unique", { value: function() {
      for (var t = this.concat(), e = 0; e < t.length; ++e)
        for (var r = e + 1; r < t.length; ++r)
          t[e] === t[r] && t.splice(r--, 1);
      return t;
    }, writable: true, configurable: true, enumerable: false }), Array.prototype.has || Object.defineProperty(Array.prototype, "has", { value: function(t) {
      for (var e = 0; e < this.length; e++)
        if (this[e] == t)
          return true;
      return false;
    }, writable: true, configurable: true, enumerable: false }), Array.prototype.compare || Object.defineProperty(Array.prototype, "compare", { value: function(t) {
      ...
      for (var e = 0; e < this.length; e++)
        if (!t.has(this[e]))
          return false;
      return true;
    }, writable: true, configurable: true, enumerable: false }), Object.assign || Object.defineProperty(Object, "assign", { value: function(t, e) {
      "use strict";
      if (null == t)
      ...
      return r;
    }, writable: true, configurable: true }), OrgChart.prototype._globalMouseDownHandler = function(t, e) {
      var r = { move: "mousemove", up: "mouseup", leave: "mouseleave" };
      if (-1 != e.type.indexOf("touch") && (1 == e.touches.length ? this._touch = { x: e.touches[0].clientX, y: e.touches[0].clientY } : this._touch = null, r = { move: "touchmove", up: "touchend", touchstart: "touchstart" }), t == e.target)
      ...
      if (-1 != e.type.indexOf("touch") && this._touch && 1 == e.changedTouches.length) {
        if (e.changedTouches.length) {
          var r = { x: e.changedTouches[0].clientX, y: e.changedTouches[0].clientY }, i = OrgChart.t(this.config.template, false, this.getScale()).size, a = this.getScale(), n = Math.abs(r.x - this._touch.x) / a, o = Math.abs(r.y - this._touch.y) / a;
          if (this._touch = null, n > i[0] / 10)
            return;
          if (o > i[1] / 10)
            return;
        }
      ...
      for (var l = e.target; l != t; ) {
        ...
        if (l.hasAttribute(OrgChart.attr.c_link_from))
          return void OrgChart.events.publish("clink-click", [this, { from: l.getAttribute(OrgChart.attr.c_link_from), to: l.getAttribute(OrgChart.attr.c_link_to), event: e }]);
        if (l.hasAttribute(OrgChart.attr.s_link_from))
          return void OrgChart.events.publish("slink-click", [this, { from: l.getAttribute(OrgChart.attr.s_link_from), to: l.getAttribute(OrgChart.attr.s_link_to), event: e }]);
        l = l.parentNode;
      }
      ...
      if (this.config.mouseScrool != OrgChart.action.ctrlZoom || e.ctrlKey) {
        var r = this, i = false, a = this.config.zoom.speed, n = this.config.zoom.smooth, o = 0, l = this.getScale(), s = OrgChart._centerPointInPercent(t, e.pageX, e.pageY), h = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function(t2) {
          setTimeout(t2, 20);
        };
        e.preventDefault();
        var d = e.delta || e.wheelDelta;
        void 0 === d && (d = -e.detail), d = Math.max(-1, Math.min(1, d)), o += -d * a, i || function t2() {
          i = true;
          var e2 = (o - l) / n;
          e2 > 0 ? e2++ : e2--, l += e2, r.zoom(1 - e2 / 12 / 50, s), parseInt(l) == parseInt(o) ? i = false : h(t2);
        }();
      }
    }, OrgChart.prototype._nodeCircleNodeMenuItemMouseDownHandler = function(t, e, r) {
      var i = t.parentNode.getAttribute(OrgChart.attr.control_node_circle_menu_wrraper_id), a = t.getAttribute(OrgChart.attr.control_node_circle_menu_name), n = this.nodeCircleMenuUI._menu[a];
      if (n.draggable) {
        var o = this, l = OrgChart._getClientXY(e), s = this.getNode(i);
        t._dragEventFired = false;
        ...
        var g = this.getSvg(), p = { x: l.x, y: l.y }, u = t.cloneNode(true);
        g.insertBefore(u, g.firstChild);
        var f = OrgChart._getTransform(u), m = f[4], C = f[5], b = function(t2) {
          for (; t2 && !t2.hasAttribute(OrgChart.attr.control_node_circle_menu_wrraper_id); )
            t2 = t2.parentNode;
          if (t2) {
            var e2 = OrgChart._getTransform(t2);
            return { x: e2[4], y: e2[5] };
          }
        ...
        var O = function(t2, e2) {
          if (null != t2) {
            e2.classList.remove("boc-drag-over");
            for (var r2 = OrgChart.getStParentNodes(o.getNode(d)), i2 = 0; i2 < r2.length; i2++) {
              var a2 = o.getNodeElement(r2[i2].id);
              a2 && (a2.style.opacity = 1);
            }
          }
        }, v = function(e2) {
          if (p) {
            var r2 = OrgChart._getClientXY(e2), i2 = e2.target;
            OrgChart.isMobile() && (i2 = document.elementFromPoint(r2.x, r2.y)), r2.x += b.x * h, r2.y += b.y * h;
            var l2 = OrgChart._getOffsetXY(o.element, e2), s2 = { left: o.width() - (l2.x + o.config.padding) < 0, right: l2.x - o.config.padding < 0, down: o.height() - (l2.y + o.config.padding) < 0, up: l2.y - o.config.padding < 0 };
            if (s2.left || s2.right || s2.up || s2.down) {
              ...
              var v2 = f[4], y = f[5], _ = p.x, w = p.y, k = r2.x, S = r2.y;
              o.startMove(s2, function(t2) {
                f[4] = v2 + t2.x, f[5] = y + t2.y, p.x = _ - t2.xWithoutScale, p.y = w - t2.yWithoutScale, r2.x = k - t2.xWithoutScale, r2.y = S - t2.yWithoutScale, u.setAttribute("transform", "matrix(" + f.toString() + ")");
              });
            } else {
              for (o.stopMove(), g.classList && (g.classList.add("boc-cursor-grab"), g.classList.remove("boc-cursor-move"), g.classList.remove("boc-cursor-nodrop"), g.classList.remove("boc-cursor-copy")), O(d, c), d = null, c = null; null != i2 && i2 != g; ) {
                if (i2.hasAttribute && i2.hasAttribute(OrgChart.attr.node_id)) {
                  var I = i2.getAttribute(OrgChart.attr.node_id);
                  d = I, c = i2;
                  break;
                }
                i2 = i2.parentNode;
              ...
              if (null != d) {
                ...
                for (var A = o.getNode(d), E = OrgChart.getStParentNodes(A), L = 0; L < E.length; L++) {
                  var N = o.getNodeElement(E[L].id);
              ...
              var M = (r2.x - p.x) / h, T = (r2.y - p.y) / h;
              if (f[4] = m + M, f[5] = C + T, !t._dragEventFired && (Math.abs(r2.x - p.x) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(r2.y - p.y) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE))
                false === OrgChart.events.publish("drag", [o.nodeCircleMenuUI, { from: I, menuItem: n, menuItemName: a }]) && x(), t._dragEventFired = true;
              u.setAttribute("transform", "matrix(" + f.toString() + ")");
            }
          }
        }, x = function(e2) {
          if (o.stopMove(), g.classList && (g.classList.remove("boc-cursor-grab"), g.classList.remove("boc-cursor-move"), g.classList.remove("boc-cursor-nodrop"), g.classList.remove("boc-cursor-copy")), g.removeEventListener(r.move, v), g.removeEventListener(r.up, x), r.leave && g.removeEventListener(r.leave, x), s.id == d || null == d)
            return g.removeChild(u), o._gragStartedId = null, void (t._dragEventFired && OrgChart.events.publish("drop", [o.nodeCircleMenuUI, { from: s.id, menuItemName: a, menuItem: n }]));
          var i2 = o.getNode(d);
          OrgChart.events.publish("drop", [o.nodeCircleMenuUI, { from: s.id, to: i2.id, menuItem: n, menuItemName: a }]), O(d, c), g.removeChild(u), o._gragStartedId = null;
        };
      ...
      if (this.config.enableDragDrop) {
        ...
        var s = this, h = this.getSvg(), d = { x: i.x, y: i.y }, c = OrgChart._getTransform(t), g = c[4], p = c[5], u = s.getScale(), f = t.cloneNode(true);
        f.setAttribute("data-n-id", "draging"), h.insertBefore(f, h.firstChild), f.style.opacity = 0.7;
        var m = function(t2, e2) {
          if (null != t2) {
            e2.classList.remove("boc-drag-over");
            for (var r2 = s.getNode(o), i2 = OrgChart.getStParentNodes(r2), a2 = 0; a2 < i2.length; a2++) {
              var n2 = s.getNodeElement(i2[a2].id);
              n2 && (n2.style.opacity = 1);
            }
          }
        }, C = function(e2) {
          if (d) {
            var r2 = OrgChart._getClientXY(e2), i2 = e2.target;
            OrgChart.isMobile() && (i2 = document.elementFromPoint(r2.x, r2.y));
            var a2 = OrgChart._getOffsetXY(s.element, e2), C2 = { left: s.width() - (a2.x + s.config.padding) < 0, right: a2.x - s.config.padding < 0, down: s.height() - (a2.y + s.config.padding) < 0, up: a2.y - s.config.padding < 0 };
            if (C2.left || C2.right || C2.up || C2.down) {
              ...
              var O = c[4], v = c[5], x = d.x, y = d.y, _ = r2.x, w = r2.y;
              s.startMove(C2, function(t2) {
                c[4] = O + t2.x, c[5] = v + t2.y, d.x = x - t2.xWithoutScale, d.y = y - t2.yWithoutScale, r2.x = _ - t2.xWithoutScale, r2.y = w - t2.yWithoutScale, f.setAttribute("transform", "matrix(" + c.toString() + ")");
              });
            } else {
              if (s.stopMove(), h.classList && (h.classList.add("boc-cursor-grab"), h.classList.remove("boc-cursor-move"), h.classList.remove("boc-cursor-nodrop"), h.classList.remove("boc-cursor-copy")), m(o, l), o = null, l = null, s.config.enableDragDrop)
                for (; null != i2 && i2 != h; ) {
                  if (i2.hasAttribute && i2.hasAttribute(OrgChart.attr.node_id)) {
                    var k = i2.getAttribute(OrgChart.attr.node_id);
              ...
              var L = (r2.x - d.x) / u, N = (r2.y - d.y) / u;
              if (c[4] = g + L, c[5] = p + N, !t._dragEventFired && (Math.abs(r2.x - d.x) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(r2.y - d.y) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE))
                false === OrgChart.events.publish("drag", [s, k, e2]) && b(), t._dragEventFired = true;
              f.setAttribute("transform", "matrix(" + c.toString() + ")");
            }
          }
        }, b = function(e2) {
          if (s.stopMove(), h.classList && (h.classList.remove("boc-cursor-grab"), h.classList.remove("boc-cursor-move"), h.classList.remove("boc-cursor-nodrop"), h.classList.remove("boc-cursor-copy")), h.removeEventListener(r.move, C), h.removeEventListener(r.up, b), r.leave && h.removeEventListener(r.leave, b), n.id == o || null == o)
            return t._dragEventFired && OrgChart.events.publish("drop", [s, n.id, void 0, f]), h.removeChild(f), void (s._gragStartedId = null);
          var i2 = s.getNode(o);
          if (false === OrgChart.events.publish("drop", [s, n.id, i2.id, f]))
            return m(o, l), h.removeChild(f), void (s._gragStartedId = null);
          if (s.canUpdateLink(n.id, o)) {
            var a2 = s.get(n.id);
            a2.pid = o, a2.stpid = null, s.updateNode(a2, null, true);
          } else
            h.removeChild(f), m(o, l);
      ...
      if (this.isVisible) {
        var r = this.getViewBox(), i = this.getSvg(), a = i.getAttribute("width"), n = i.getAttribute("height"), o = a / r[2], l = n / r[3], s = o > l ? l : o;
        i.setAttribute("width", this.width()), i.setAttribute("height", this.height()), r[2] = this.width() / s, r[3] = this.height() / s, this.setViewBox(r), this.xScrollUI.create(this.width()), this.yScrollUI.create(this.height()), this._draw(false, OrgChart.action.resize);
      }
    }, OrgChart.prototype._nodeDbClickHandler = function(t, e) {
      if (false === OrgChart.events.publish("dbclick", [this, this.get(t)]))
        return false;
      ...
      if (r && r._dragEventFired)
        r._dragEventFired = false;
      else {
        if (false === OrgChart.events.publish("click", [this, { node: this.getNode(t), event: e }]))
          return false;
        this._commonClickHandler(t, e, this.config.nodeMouseClick);
      }
    }, OrgChart.prototype._nodeCircleMenuItemClickHandler = function(t, e) {
      var r = t.parentNode.getAttribute(OrgChart.attr.control_node_circle_menu_wrraper_id), i = t.getAttribute(OrgChart.attr.control_node_circle_menu_name), a = this.nodeCircleMenuUI._menu[i];
      ...
      r == OrgChart.action.details && ((i = this.getNode(t)) && (this.editUI.show(i.id, true), this.ripple(i.id, e.clientX, e.clientY)));
      ...
      false !== this.addNode(t, null, true) && this.center(t.id);
    }, OrgChart.prototype.toggleExpandCollapse = function(t, e) {
      var r = this.getNode(t), i = this.getCollapsedIds(r);
      if (i.length) {
        if (false === OrgChart.events.publish("expcollclick", [this, false, t, i]))
          return false;
        this.expand(t, i, false);
      } else {
        if (false === OrgChart.events.publish("expcollclick", [this, true, t, r.childrenIds]))
          return false;
        this.collapse(t, r.childrenIds, false);
      }
      ...
      if (t) {
        if (this._movePosition = t, !this._moveInterval) {
          ...
          this._moveInterval = setInterval(function() {
            var t2 = { x: 0, y: 0, xWithoutScale: 0, yWithoutScale: 0 };
            r._movePosition.left && (n++, t2.x = n * OrgChart.MOVE_STEP / a, t2.xWithoutScale = n * OrgChart.MOVE_STEP), r._movePosition.right && (n++, t2.x = -n * OrgChart.MOVE_STEP / a, t2.xWithoutScale = -n * OrgChart.MOVE_STEP), r._movePosition.up && (o++, t2.y = -o * OrgChart.MOVE_STEP / a, t2.yWithoutScale = -o * OrgChart.MOVE_STEP), r._movePosition.down && (o++, t2.y = o * OrgChart.MOVE_STEP / a, t2.yWithoutScale = o * OrgChart.MOVE_STEP), r.setViewBox([i[0] + t2.x, i[1] + t2.y, i[2], i[3]]), r.xScrollUI.setPosition(), r.yScrollUI.setPosition(), e && e(t2);
      ...
      var a = this.getViewBox(), n = this.getScale(), o = OrgChart._getClientTouchesXY(e, 0), l = OrgChart._getClientTouchesXY(e, 1), s = { diffX: 0, diffY: 0, x0: o.x, y0: o.y, type: "pan", viewBoxLeft: a[0], viewBoxTop: a[1] };
      ...
      var h = function(t2) {
        var e2 = OrgChart._getClientTouchesXY(t2, 0);
        if (s && "pan" == s.type) {
          i._hideBeforeAnimation(), s.diffX = e2.x - s.x0, s.diffY = e2.y - s.y0;
          var r2 = -s.diffY / n + s.viewBoxTop, o2 = -s.diffX / n + s.viewBoxLeft;
          i._move(r2, o2, a);
        } else if (s && "pinch" == s.type) {
          var l2 = OrgChart._getClientTouchesXY(t2, 1), h2 = Math.sqrt((e2.x - l2.x) * (e2.x - l2.x) + (e2.y - l2.y) * (e2.y - l2.y)), d2 = 1 + (h2 - s.dist) / (s.dist / 100) / 100;
          s.dist = h2;
          var c = OrgChart._pinchMiddlePointInPercent(i.element, i.width(), i.height(), t2);
          i.zoom(d2, c);
        }
      }, d = function() {
        "pan" == s.type && i.config.sticky ? setTimeout(function() {
          OrgChart._moveToBoundaryArea(t, i.getViewBox(), i.response.boundary, function() {
            i._draw(true, OrgChart.action.pan);
          });
      ...
      var i = this.getPointerElement(), a = OrgChart._getOffsetXY(this.element, r), n = a.x / e + t[0] - 16 / e, o = a.y / e + t[1] - 16 / e;
      i.style.display = "inherit", i.setAttribute("transform", "matrix(0,0,0,0," + n + "," + o + ")"), OrgChart.animate(i, { transform: [0, 0, 0, 0, n, o], opacity: 0 }, { transform: [1 / e, 0, 0, 1 / e, n, o], opacity: 1 }, 300, OrgChart.anim.outBack);
    }, OrgChart.prototype._changeCursorOnPanEnd = function() {
      this.getPointerElement().style.display = "none";
    }, OrgChart.searchUI = function() {
      this.lastSearch = [], this._searchAfterEnterPress = false;
    }, OrgChart.searchUI.prototype.init = function(t) {
      this.obj = t, this._initSearchFields();
      var e = this, r = this.obj.config.padding - 10, i = this.obj.config.padding - 10, a = this.obj.getMenuButton();
      if (a) {
        var n = a.getBoundingClientRect(), o = this.obj.getSvg().getBoundingClientRect();
      ...
      this.obj.element.insertBefore(l, h), OrgChart.input.init(l), this.input = document.getElementById(s.id), this.xBtn.addEventListener("click", function(t2) {
        t2.preventDefault(), e.hide();
      }), this.input.addEventListener("keypress", function(t2) {
        "Enter" == t2.key && t2.preventDefault();
      }), this.input.addEventListener("focus", function(t2) {
        e.xBtn.style.display = "", e._search();
      }), this.input.addEventListener("blur", function(t2) {
        OrgChart.isNEU(e.input.value) && OrgChart.SEARCH_HELP_SYMBOL != e.input.value && (e.xBtn.style.display = "none");
      }), this.input.addEventListener("keydown", function(t2) {
        ("ArrowDown" == t2.key || "ArrowUp" == t2.key) && t2.preventDefault();
      }), this.input.addEventListener("keyup", function(t2) {
        "ArrowDown" == t2.key ? d() : "ArrowUp" == t2.key ? c() : "Enter" == t2.key ? e._enterHandler() : "Escape" == t2.key ? e.hide() : e._search();
      });
      var d = function() {
        var t2 = e.obj.element.querySelectorAll("[data-search-item-id]"), r2 = e.obj.element.querySelector('[data-selected="yes"]');
        null == r2 && t2.length > 0 ? t2[0].setAttribute("data-selected", "yes") : t2.length > 0 && r2.nextSibling && r2.nextSibling.setAttribute && (r2.removeAttribute("data-selected"), r2.nextSibling.setAttribute("data-selected", "yes"));
      }, c = function() {
        var t2 = e.obj.element.querySelectorAll("[data-search-item-id]"), r2 = e.obj.element.querySelector('[data-selected="yes"]');
        null == r2 && t2.length > 0 ? t2[t2.length - 1].setAttribute("data-selected", "yes") : t2.length > 0 && r2.previousSibling && r2.previousSibling.setAttribute && (r2.removeAttribute("data-selected"), r2.previousSibling.setAttribute("data-selected", "yes"));
      };
      ...
      if (t) {
        if (t.hasAttribute("data-search-item-id")) {
          ...
          if (this.input.value != OrgChart.SEARCH_HELP_SYMBOL)
            0 != OrgChart.events.publish("searchclick", [that.obj, e]) && this.obj.center(e);
          else
            this.input.value = e + " ", this.searchTableWrapper.innerHTML = "";
        }
      } else
        this._searchAfterEnterPress = true, this.__search(), this.searchTableWrapper.innerHTML = "", this.obj.draw();
      ...
      if (null == this.obj.config.searchFields) {
        ...
        this._searchFields = this.obj.config.searchFields;
      if (null == this.obj.config.searchFieldsAbbreviation) {
        this._searchFieldsAbbreviation = {};
        for (t = 0; t < this._searchFields.length; t++) {
          for (var r = this._searchFields[t], i = 0, a = r.slice(0, i + 1).toLowerCase(); this._searchFieldsAbbreviation[a]; )
      ...
      var t, e = this;
      if (this._searchAfterEnterPress = false, this.input.value == OrgChart.SEARCH_HELP_SYMBOL)
        t = this.helpView();
      else {
        this.__search();
        ...
        t = `<table border="0" cellspacing="0" cellpadding="0">
                        <tbody>
                            ${function() {
          for (var t2 = "", i2 = 0; i2 < e.lastSearch.length && !(i2 >= OrgChart.SEARCH_RESULT_LIMIT); i2++) {
            var a2 = e.lastSearch[i2], n = "";
            if (r) {
              var o = e.obj._get(a2.id);
              "function" == typeof r ? n = r(e.obj, e.obj.getNode(a2.id), o) : o[r] && (n = o[r]);
            }
            var l = "", s = "";
            e.obj.config.searchDisplayField == a2.__searchField ? l = a2.__searchMarks : e.obj.config.searchDisplayField ? (l = a2[e.obj.config.searchDisplayField], OrgChart.isNEU(l) && (l = ""), s = a2.__searchMarks) : l = a2.__searchMarks, t2 += OrgChart.searchUI.createItem(n, a2.id, l, s);
          }
          return t2;
        }()}  
                        </tbody>
      ...
      for (var i = this.obj.element.querySelectorAll("[data-search-item-id]"), a = 0; a < i.length; a++)
        i[a].addEventListener("click", function() {
          if (this.hasAttribute("data-search-item-id")) {
            var t2 = this.getAttribute("data-search-item-id");
            if (e.input.value != OrgChart.SEARCH_HELP_SYMBOL) {
              if (false !== OrgChart.events.publish("searchclick", [e.obj, t2])) {
                e.obj.center(this.getAttribute("data-search-item-id"));
                var r2 = e.obj.element.querySelector('[data-selected="yes"]');
                r2 && r2.removeAttribute("data-selected"), this.setAttribute("data-selected", "yes"), e.input.focus();
              }
            } else
              e.input.value = t2 + " ", e.searchTableWrapper.innerHTML = "", e.input.focus();
          }
        });
      ...
      this._searchAfterEnterPress && (this._searchAfterEnterPress = false, this.obj.draw()), this.lastSearch = [], this.xBtn && (this.xBtn.style.display = "none"), this.searchTableWrapper && (this.searchTableWrapper.innerHTML = ""), this.input && (this.input.value = "", document.activeElement == this.input && this.input.blur(), document.activeElement == this.xBtn && OrgChart.input.blurHandler(this.input));
    }, void 0 === OrgChart && (OrgChart = {}), OrgChart.manager = function(t) {
      this.config = t.config, this.layoutConfigs = t._layoutConfigs, this.visibleNodeIds = [], this.viewBox = null, this.action = null, this.actionParams = null, this.nodes = {}, this.oldNodes = {}, this.maxX = null, this.maxY = null, this.minX = null, this.minY = null, this.bordersByRootIdAndLevel = null, this.roots = null, this.state = null, this.vbIsInitializedFromState = false, this.rootList = [], this.instance = t;
    }, OrgChart.manager.prototype.read = function(t, e, r, i, a, n, o, l) {
      var s = this;
      OrgChart.state._get(this.config.state, e, r, function(h) {
        s.state = h, s.action = a, s.actionParams = n, a != OrgChart.action.init || !s.state || n && n.method && "fit" == n.method ? (s.viewBox = i, s.vbIsInitializedFromState = false) : (s.viewBox = s.state.vb, s.vbIsInitializedFromState = true, Array.isArray(s.state.roots) && (s.config.roots = s.state.roots));
        ...
        if (t) {
          ...
          a != OrgChart.action.exporting && (s.maxX = d, s.maxY = c, s.minX = g, s.minY = p, s.roots = f, s.nodes = m, s.visibleNodeIds = C.visibleNodeIds), C.bordersByRootIdAndLevel = u, C.roots = f, C.adjustify = { x: 0, y: 0 }, s.state && (C.adjustify = s.state.adjustify), o(C);
        } else
          s.oldNodes = m || null, s._read(function(t2) {
            d = t2.maxX, c = t2.maxY, g = t2.minX, p = t2.minY, u = t2.bordersByRootIdAndLevel, f = t2.roots, m = t2.nodes;
            var i2 = OrgChart.manager._getResponse(e, r, s.visibleNodeIds, s.config, d, c, g, p, s.viewBox, f, s.action, s.actionParams, m, s.oldNodes, s.vbIsInitializedFromState);
            i2.notif = t2.limit, i2.roots = f, i2.bordersByRootIdAndLevel = u, i2.adjustify = t2.adjustify, a != OrgChart.action.exporting && (s.maxX = d, s.maxY = c, s.minX = g, s.minY = p, s.roots = f, s.nodes = m, s.visibleNodeIds = i2.visibleNodeIds, s.bordersByRootIdAndLevel = u, s.rootList = t2.rootList), o(i2);
          }, l);
      });
      ...
      null == o && (o = OrgChart.local), o._setPositions(n, r.layoutConfigs, function(e2) {
        var o2 = OrgChart.manager._doNotChangePositionOfClickedNodeIfAny(n, a, r.action, r.actionParams, r.oldNodes, r.config.orientation);
        r.state && r.action == OrgChart.action.init && (o2 = r.state.adjustify);
        for (var l = { minX: null, minY: null, maxX: null, maxY: null }, s = {}, h = 0; h < n.length; h++)
          OrgChart.manager._setMinMaxXYAdjustifyIterate(n[h], n[h], l, 0, s, o2, r.config.orientation);
        t({ minX: l.minX, minY: l.minY, maxX: l.maxX, maxY: l.maxY, bordersByRootIdAndLevel: s, nodes: a, roots: n, rootList: i.rootList, limit: e2, adjustify: o2 });
      }, a);
    }, void 0 === OrgChart && (OrgChart = {}), OrgChart.manager._initDinamicNode = function(t, e, r) {
      e && (t.lcn = e), r && (t.isAssistant = true);
      ...
      null == t.collapsed && e.collapse && e.collapse.allChildren ? t.collapsed = true : null == t.collapsed && (t.collapsed = false), a == OrgChart.action.expand && -1 != r.ids.indexOf(t.id) && (t.collapsed = false), a == OrgChart.action.collapse && (r.expandIds || r.collapseIds) ? r.expandIds && -1 != r.expandIds.indexOf(t.id) ? t.collapsed = false : r.collapseIds && -1 != r.collapseIds.indexOf(t.id) && (t.collapsed = true) : a == OrgChart.action.collapse && -1 != r.ids.indexOf(t.id) && (t.collapsed = true), a == OrgChart.action.expand && "all" == r.ids && (t.collapsed = false), a == OrgChart.action.exporting && r.expandChildren && (t.collapsed = false), a == OrgChart.action.init && null != o ? t.collapsed = !o.exp.has(t.id) : a == OrgChart.action.init ? t.collapsed = e.collapse && n >= e.collapse.level - 1 && -1 == i.indexOf(t.id) : a == OrgChart.action.centerNode || a == OrgChart.action.insert || a == OrgChart.action.expand || a == OrgChart.action.collapse ? i.has(t.id) && (t.collapsed = false) : a == OrgChart.action.update && r && r.changeRoots && r.changeRoots.has(t.id) && (t.collapsed = false);
    }, OrgChart.manager._initNode = function(t, e, r, i, a, n, o) {
      var l = o.manager.config, s = o.manager.layoutConfigs, h = o.manager.action, d = o.manager.actionParams, c = o.manager.state, g = s[r || "base"];
      ...
      if (h != OrgChart.action.minimize || t.min ? h == OrgChart.action.maximize && true === t.min ? (d.all || d.id == t.id) && (t.min = false) : h == OrgChart.action.exporting && false === d.min ? t.min = false : h == OrgChart.action.init && null != c && (t.min = c.min.has(t.id)) : (d.all || d.id == t.id) && (t.min = true), !t.min)
      ...
      m > 0 && (t.subLevels = m), -1 != t.tags.indexOf("assistant") && null != t.parent && (t.isAssistant = true);
      ...
      for (var s = [], h = OrgChart._addDottedLines(r), d = 0; d < h.length; d++) {
        ...
        true === p ? c.unshift("match") : false === p && c.unshift("no-match");
        var u = OrgChart._getTemplate(c, r.tags, r.template), f = new OrgChart.node(g.id, g.pid, c, u);
        OrgChart.isNEU(g.ppid) || (f.ppid = g.ppid), OrgChart.isNEU(g.stpid) || (f.stpid = g.stpid), null != r.orderBy && (f.order = OrgChart.manager._getOrderFieldValue(g, r.orderBy)), t[g.id] = f, s.push(g.id);
      }
      null != r.orderBy && s.sort(function(e2, i2) {
        var a2 = t[e2].order, n2 = t[i2].order;
        return "number" == typeof a2 || "number" == typeof n2 ? (null == a2 && (a2 = -1), null == n2 && (n2 = -1), r.orderBy.desc ? n2 - a2 : a2 - n2) : "string" == typeof a2 || "string" == typeof n2 ? (null == a2 && (a2 = ""), null == n2 && (n2 = ""), r.orderBy.desc ? n2.localeCompare(a2) : a2.localeCompare(n2)) : void 0;
      });
      for (d = 0; d < s.length; d++) {
        ...
        if (b || (f.stpid = null), O || (f.pid = null), b) {
          ...
          O ? (C && (f.collapsed = C.collapsed, f.min = C.min), O.childrenIds.push(f.id)) : (C && (f.collapsed = C.collapsed, f.min = C.min), e.push(f), o.push(f.id));
        i == OrgChart.action.init && (f.min = OrgChart._getMin(f, r));
      }
    }, OrgChart.manager._createNodes = function(t) {
      var e = t.manager.config, r = t.manager.layoutConfigs, i = t.manager.action, a = t.manager.actionParams, n = t.manager.oldNodes, o = t.manager.state, l = {}, s = [], h = [];
      if (OrgChart.manager.__createNodes(l, s, e, i, a, n, h, t), null != e.roots) {
        ...
        for (var d = 0; d < e.roots.length; d++) {
          ...
          if (c) {
            for (var u = false, f = 0; f < s.length; f++)
              if (s[f].id == c.id) {
                u = true;
                break;
              }
            if (!u) {
              if (!OrgChart.isNEU(c.pid))
                (z = (O = l[c.pid]).childrenIds.indexOf(c.id)) > -1 && O.childrenIds.splice(z, 1);
              s.push(c);
            }
          }
        }
      ...
      if (i == OrgChart.action.init && e.expand && e.expand.nodes && null == o)
        for (d = 0; d < e.expand.nodes.length; d++) {
          ...
          for (true === e.expand.allChildren && OrgChart.manager._addExpandedNodeIdsIterate(C, l, m); C; )
            m.push(C.id), null == C.pid && null != C.stpid ? (C = l[C.stpid]).min = false : C = l[C.pid];
        }
        ...
        for (d = 0; d < b.length; d++)
          for (var O = l[(C = l[b[d]]).pid]; O; )
            m.push(O.id), null == O.pid && null != O.stpid ? (O = l[O.stpid]).min = false : O = l[O.pid];
        ...
        for (var v = l[a.id]; v; ) {
          if (m.push(v.id), a.options.parentState === OrgChart.COLLAPSE_PARENT_NEIGHBORS && v)
            for (d = 0; d < v.childrenIds.length; d++) {
              (D = l[v.childrenIds[d]]).collapsed = true;
            }
          null == v.pid && null != v.stpid ? (v = l[v.stpid]).min = false : v = l[v.pid];
        }
        v = l[a.id];
        if (a.options.childrenState === OrgChart.COLLAPSE_SUB_CHILDRENS)
          for (d = 0; d < v.childrenIds.length; d++) {
            (y = l[v.childrenIds[d]]).collapsed = false;
            for (var x = 0; x < y.childrenIds.length; x++) {
              l[y.childrenIds[x]].collapsed = true;
            }
          }
      ...
      if (i == OrgChart.action.collapse && a && Array.isArray(a.expandIds) && Array.isArray(a.collapseIds))
        for (d = 0; d < a.ids.length; d++) {
          if (a.expandIds.has(a.collapseIds[d]))
            ...
            (C = l[a.collapseIds[d]]) && (C.collapsed = true);
        }
      for (d = s.length - 1; d >= 0; d--)
        s[d].collapsed && s.splice(d, 1);
      for (d = 0; d < I.length; d++) {
        C = l[I[d]];
        var A = [], E = [], L = [], N = {}, M = 0, T = 0, B = 0, P = [], U = [];
        for (x = 0; x < C.children.length; x++) {
          (D = C.children[x]).isAssistant ? A.push(D.id) : -1 != D.tags.indexOf("right-partner") ? (D.isPartner = 1, D.children = [], E.push(D.id)) : -1 != D.tags.indexOf("left-partner") ? (D.isPartner = 2, D.children = [], L.push(D.id)) : -1 == D.tags.indexOf("partner") || M % 2 ? -1 != D.tags.indexOf("partner") && M % 2 ? (D.isPartner = 2, D.children = [], L.push(D.id), M++) : D.parentPartner ? (N[D.parentPartner.id] || (N[D.parentPartner.id] = []), N[D.parentPartner.id].push(D.id)) : A.push(D.id) : (D.isPartner = 1, D.children = [], E.push(D.id), M++);
        }
        C.children = [];
        var H = [];
        for (x = 0; x < E.length; x++) {
          N[(D = l[E[x]]).id] ? C.children.push(D) : C.children.splice(0, 0, D);
          for (var R = 0; R < D.childrenIds.length; R++)
            H.push(D.childrenIds[R]);
        }
        var F = [];
        for (x = 0; x < L.length; x++) {
          N[(D = l[L[x]]).id] ? C.children.push(D) : C.children.splice(0, 0, D);
          for (R = 0; R < D.childrenIds.length; R++)
            F.push(D.childrenIds[R]);
        }
        for (x = 0; x < F.length; x++) {
          (D = l[F[x]]).collapsed || (D.parentPartner = D.parent, D.parent = C, D.isChildOfPartner = true, C.children.push(D));
        }
        for (x = L.length - 1; x >= 0; x--)
          if (N[L[x]])
            for (f = 0; f < N[L[x]].length; f++)
              C.children.push(l[N[L[x]][f]]), T++, -1 == U.indexOf(L[x]) && U.push(L[x]);
        ...
        for (x = 0; x < E.length; x++)
          if (N[E[x]])
            for (f = 0; f < N[E[x]].length; f++)
              C.children.push(l[N[E[x]][f]]), B++, -1 == P.indexOf(E[x]) && P.push(E[x]);
        for (x = 0; x < H.length; x++) {
          (D = l[H[x]]).collapsed || (D.parentPartner = D.parent, D.parent = C, D.isChildOfPartner = true, C.children.push(D));
        }
      ...
      for (d = 0; d < k.length; d++) {
        if ((at = r[(C = l[k[d]]).lcn ? C.lcn : "base"]).layout == OrgChart.normal || !S[C.pid])
          for (x = 0; x < C.subLevels; x++) {
            var z, j = new OrgChart.node(C.id + "_sub_level_index_" + x, C.pid, [], "subLevel");
            if (OrgChart.manager._initDinamicNode(j, C.lcn), O = C.parent)
              (z = O.children.indexOf(C)) > -1 && (O.children.splice(z, 1), O.children.splice(z, 0, j)), j.children.push(C), j.parent = O, C.parent = j, l[j.id] = j;
          }
      }
      for (var Y in w) {
        (O = l[Y]).hasAssistants = true;
        j = new OrgChart.node(O.id + "_split_assitant_0", O.id, ["assistant"], "split");
        OrgChart.manager._initDinamicNode(j, O.lcn, true), l[j.id] = j;
        var q = [];
        for (x = O.children.length - 1; x >= 0; x--) {
          (D = O.children[x]).isAssistant ? (D.parent = null, O.children.splice(x, 1), q.splice(0, 0, D.id)) : D.isPartner || (D.parent && S[D.parent.id] && j && D.parent.id != j.id && (Object.defineProperty(S, j.id, Object.getOwnPropertyDescriptor(S, D.parent.id)), delete S[D.parent.id]), D.parent = j, j.children.unshift(D), O.children.splice(x, 1));
        }
        if (q.length % 2) {
          var X = l[q[q.length - 1]], $ = new OrgChart.node(X.id + "_mirror", O.pid, [], "mirror");
          OrgChart.manager._initDinamicNode($, X.lcn, true), X._m = $.id, $.isAssistant = true, $.w = X.w, $.h = X.h, l[$.id] = $, q.splice(q.length - 1, 0, $.id);
        }
        var V = 1;
        for (x = q.length - 1; x >= 0; x--)
          if (x % 2 && x != q.length - 1) {
            var G = new OrgChart.node(O.id + "_split_assitant_" + V, O.pid, [], "split");
            OrgChart.manager._initDinamicNode(G, O.lcn, true), l[G.id] = G, q.splice(x, 0, G.id), V++;
          } else
            x % 2 && q.splice(x, 0, j.id);
        for (x = 0; x < q.length; x += 3) {
          var W = null;
          W = 0 == x ? O : l[q[x - 2]];
          var J = l[q[x]], K = l[q[x + 1]], Z = l[q[x + 2]];
          J.parent = W, K.parent = W, Z.parent = W, W.children.push(J), W.children.push(K), W.children.push(Z);
        }
      }
      var Q = false;
      for (var tt in r) {
          ...
          if ((at = r[O.lcn ? O.lcn : "base"]).layout == OrgChart.mixed || at.layout == OrgChart.tree || at.layout == OrgChart.treeRightOffset || at.layout == OrgChart.treeLeftOffset || et) {
            if (rt.pnode = O, rt.layout = at.layout, rt.childrenIds = S[Y], rt.lastChildrenPidIds = S, OrgChart.events.publish("node-layout", [t, rt]), OrgChart.events.publish("layout", [rt]), rt.layout == OrgChart.mixed) {
              ...
              for (d = nt.length - 1; d >= 0; d--) {
                ...
                if (d > 0) {
                  var ot = l[nt[d - 1]];
                  D.parent = ot, D.layout = OrgChart.mixed, ot.children.push(D);
                } else
                  O.children.push(D);
              }
              ...
              OrgChart.manager._initDinamicNode(j, O.lcn), l[j.id] = j, j.layout = OrgChart.tree;
              var lt = [];
              for (d = rt.childrenIds.length - 1; d >= 0; d--) {
                ...
                if (D.parent = null, D.layout = OrgChart.tree, rt.layout == OrgChart.treeRightOffset && lt.splice(0, 0, D.id), rt.layout == OrgChart.treeLeftOffset || rt.layout == OrgChart.treeRightOffset) {
                  var st = new OrgChart.node(D.id + "_mirror", it.id, [], "mirror");
                  OrgChart.manager._initDinamicNode(st, D.lcn), st.layout = OrgChart.tree, l[st.id] = st, lt.splice(0, 0, st.id);
                }
              ...
              for (V = 1, x = lt.length - 1; x >= 0; x--)
                if (x % 2 && x != lt.length - 1) {
                  ...
                  OrgChart.manager._initDinamicNode(G, O.lcn), G.layout = OrgChart.tree, l[G.id] = G, lt.splice(x, 0, G.id), V++;
                } else
                  x % 2 && lt.splice(x, 0, j.id);
              for (x = 0; x < lt.length; x += 3) {
                W = null;
                0 == x && (W = O);
                J = l[lt[x]], K = l[lt[x + 1]], Z = l[lt[x + 2]];
                0 != x && (W = l[lt[x - 3]]), 0 == x || K || (W = l[lt[x - 2]]), J.parent = W, W.children.push(J), K && (0 != x && (W = l[lt[x - 2]]), K.parent = W, W.children.push(K)), Z && (0 != x && (W = l[lt[x - 1]]), Z.parent = W, W.children.push(Z));
              }
            }
          }
        }
      ...
      if (null != t.x && null != t.y) {
        if (e.lazyLoading && i !== OrgChart.action.exporting) {
          let a2 = function(t2, e2) {
            var r2 = t2.x, i2 = t2.y, a3 = t2.w, n2 = t2.h, o = e2[0] - OrgChart.LAZY_LOADING_FACTOR, l = e2[2] + OrgChart.LAZY_LOADING_FACTOR + e2[0], s = e2[1] - OrgChart.LAZY_LOADING_FACTOR, h = e2[3] + OrgChart.LAZY_LOADING_FACTOR + e2[1], d = r2 + a3 > o && l > r2;
            return d && (d = i2 + n2 > s && h > i2), d;
          };
          var a = a2;
          if (a2(t, r))
            return true;
          for (var n = 0; n < t.children.length; n++)
            if (a2(t.children[n], r))
              return true;
          return false;
        }
        return true;
      ...
      var f = h[0], m = [], C = { top: null, left: null, bottom: null, right: null, minX: null, maxX: null, minY: null, maxY: null }, b = [[], [], []], O = a - o + 2 * i.padding, v = n - l + 2 * i.padding, x = OrgChart.getScale(s, t, e, i.scaleInitial, i.scaleMax, i.scaleMin, O, v);
      if (C.top = l - i.padding, C.left = o - i.padding, C.bottom = n + i.padding - e / x, C.right = a + i.padding - t / x, C.maxX = a, C.minX = o, C.maxY = n, C.minY = l, 0 == h.length || null == s && !u && i.align == OrgChart.CENTER) {
        ...
        if (y - 2 * i.padding >= a - o)
          ...
          switch (w = f.x - y / 2 + OrgChart.manager._getNodeWidth(f, i) / 2, i.orientation) {
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
      ...
      if (d == OrgChart.action.insert || d == OrgChart.action.expand || d == OrgChart.action.collapse || d == OrgChart.action.update || d == OrgChart.action.centerNode || d == OrgChart.action.maximize) {
        ...
        if (d == OrgChart.action.insert && c && null != c.insertedNodeId && null != c.insertedNodeId)
          ...
          I = g[c.id], I = OrgChart.manager._getMostDeepChild(I, g);
      ...
      if (OrgChart.manager._isVisible(t, r, i, a)) {
        ...
        if ((a == OrgChart.action.expand || a == OrgChart.action.collapse || a == OrgChart.action.maximize) && l && l[t.id] && "expandCollapseToLevel" == n.method) {
          ...
          if (null != (u = l[t.id]).x && null != u.y && (d = { x: u.x, y: u.y }), (p = e[n.id]) && p == t)
            (c = t.parent) && c.id == n.id && (d = { x: p.x + p.w / 2 - t.w / 2, y: p.y + p.h / 2 - t.h / 2 });
      ...
      if (3 == t.children.length)
        OrgChart.manager._verticalAssistantIterate(t.children[0], e), OrgChart.manager._verticalAssistantIterate(t.children[2], e), OrgChart.manager._verticalAssistantIterate(t.children[1], e);
      else
      ...
      if (t.isAssistant && t.isSplit && t.children.length) {
        ...
        for (r = 0; r < s; r++) {
          ...
          OrgChart.manager._initDinamicNode(d, t.lcn, true), r > 0 && (h[r - 1].children.push(d), d.parent = h[r - 1]), e[d.id] = d, h.push(d);
        }
        if (h.length) {
      ...
      return e === OrgChart.action.exporting ? "" : OrgChart.t(t.template, false, r).pointer;
      ...
      for (var p in o) {
        ...
        if (g.value = u, g.element = d[p], g.name = f, false !== OrgChart.events.publish("field", [h, g]) && null != g.value && null != g.value && null != g.element) {
      ...
      var x = "";
      t.lcn && (x = 'lcn="' + t.lcn + '"');
      var y = OrgChart.nodeOpenTag.replace("{lcn}", x).replace("{id}", t.id).replace("{class}", v).replace("{sl}", t.sl).replace("{level}", t.level).replace("{x}", O.x).replace("{y}", O.y), _ = OrgChart._getOpacity(r, t);
      return c = (y = y.replace("{opacity}", _)) + (c += OrgChart.ui.nodeBtns(i, t, l, d, h)) + OrgChart.grCloseTag;
      ...
      if (i !== OrgChart.action.exporting && !e.isSplit) {
        ...
        if (e.childrenIds.length > 0) {
          if (e.hasPartners) {
            for (var d = false, c = 0; c < e.childrenIds.length; c++) {
              var g = t.getNode(e.childrenIds[c]);
              !g || g.parentPartner || g.isPartner || (d = true);
            }
            if (!d)
              return "";
          }
      ...
      var o = t.lcn ? t.lcn : "base", l = e._layoutConfigs[o], s = OrgChart.t(t.templateName, t.min, r), h = [], d = l.levelSeparation / 2;
      t.layout != OrgChart.mixed && t.layout != OrgChart.tree || (d = l.mixedHierarchyNodesSeparation / 2);
      var c = 0, g = OrgChart.getRootOf(t).id, p = i[g][t.sl], u = void 0;
      if (t.hasPartners) {
        u = { ids: [], indexes: {}, ppnodes: {}, lastLeft: null, firstRight: null, maxSidePartnersWithChildren: 0, rightIds: [], leftIds: [], partnerChildrenSplitSeparation: e.config.partnerChildrenSplitSeparation };
      ...
      for (f = 0; f < t.children.length; f++) {
        var m = t.children[f], C = i[g][m.sl], b = { xa: 0, ya: 0, xb: 0, yb: 0, xc: 0, yc: 0, xd: 0, yd: 0, x: 0, y: 0, rotate: 0 }, O = (s = OrgChart.t(m.templateName, m.min, r)).link;
        if (m.isChildOfPartner)
          ...
          var x = m.isAssistant && m.rightNeighbor && m.rightNeighbor.isAssistant && m.parent == m.rightNeighbor.parent, y = m.isAssistant && m.leftNeighbor && m.leftNeighbor.isAssistant && m.parent == m.leftNeighbor.parent;
        ...
        if (-1 != O.indexOf("{rounded}"))
          ...
          else if (Math.abs(b.xa - b.xd) <= OrgChart.LINK_ROUNDED_CORNERS && Math.abs(b.xa - b.xc) <= OrgChart.LINK_ROUNDED_CORNERS && Math.abs(b.xa - b.xb) <= OrgChart.LINK_ROUNDED_CORNERS)
            O = O.replace("{rounded}", "M" + b.xa + "," + b.ya + " L" + b.xa + "," + b.yd);
          else if (Math.abs(b.ya - b.yd) <= OrgChart.LINK_ROUNDED_CORNERS && Math.abs(b.ya - b.yc) <= OrgChart.LINK_ROUNDED_CORNERS && Math.abs(b.ya - b.yb) <= OrgChart.LINK_ROUNDED_CORNERS)
            O = O.replace("{rounded}", "M" + b.xa + "," + b.ya + " L" + b.xd + "," + b.ya);
          else {
            var _ = OrgChart.ui._roundedEdge(b.xa, b.ya, b.xb, b.yb, b.xc, b.yc), w = OrgChart.ui._roundedEdge(b.xb, b.yb, b.xc, b.yc, b.xd, b.yd);
        ...
        for (var I in e.config.linkBinding) {
          var A = e.config.linkBinding[I], E = e._get(m.id);
          if (E) {
            var L = E[A];
            k.value = L, k.element = s[I], k.name = A, false !== OrgChart.events.publish("label", [e, k]) && (OrgChart.isNEU(k.value) || OrgChart.isNEU(k.element) || (S += k.element.replace("{val}", k.value)));
          }
        }
      ...
      return OrgChart.t(i.template, false, n).svg.replace("{w}", t).replace("{h}", e).replace("{viewBox}", r).replace("{randId}", OrgChart.ui._defsIds[i.template]).replace("{mode}", i.mode).replace("{template}", i.template).replace("{content}", function() {
        return a;
      });
    }, menuButton: function(t) {
      return null == t.menu ? "" : OrgChart.t(t.template, false).menuButton.replaceAll("{p}", t.padding);
    }, _roundedEdge: function(t, e, r, i, a, n) {
      var o, l, s, h = OrgChart.LINK_ROUNDED_CORNERS, d = 0;
      return t == r && t == a || e == i && e == n ? (o = s = r, l = d = i) : (t != a && r == a && (o = s = r, l = i, e < n ? d = i + h : e > n && (d = i - h)), t < a && r == a ? r -= h : t > a && r == a && (r += h), e != n && i == n && (o = r, l = d = i, t < a ? s = r + h : t > a && (s = r - h)), e < n && i == n ? i -= h : e > n && i == n && (i += h)), { x1: t, y1: e, x2: r, y2: i, x3: a, y3: n, qx1: o, qy1: l, qx2: s, qy2: d };
      ...
      if (OrgChart.isObject(t) && OrgChart.isObject(e))
        for (var r in e)
          OrgChart.isObject(e[r]) ? (t[r] || Object.assign(t, { [r]: {} }), OrgChart.mergeDeep(t[r], e[r])) : Object.assign(t, { [r]: e[r] });
      return t;
      ...
      n.className = "boc-ripple-container", t.addEventListener("mousedown", function(e2) {
        var r2, i2, a2, n2, o;
        return this, i2 = document.createElement("span"), a2 = this.offsetWidth, r2 = this.getBoundingClientRect(), o = e2.pageX - r2.left - a2 / 2, n2 = "top:" + (e2.pageY - r2.top - a2 / 2) + "px; left: " + o + "px; height: " + a2 + "px; width: " + a2 + "px;", t.rippleContainer.appendChild(i2), i2.setAttribute("style", n2);
      }), t.addEventListener("mouseup", (r = function() {
        for (; this.rippleContainer.firstChild; )
          this.rippleContainer.removeChild(this.rippleContainer.firstChild);
      }, i = 2e3, a = void 0, function() {
        var t2, e2;
        return e2 = this, t2 = arguments, clearTimeout(a), a = setTimeout(function() {
          return r.apply(e2, t2);
        }, i);
      ...
      var a = OrgChart._getTopLeft(t), n = i.touches[0].pageX - a.x, o = i.touches[0].pageY - a.y, l = i.touches[1].pageX - a.x, s = i.touches[1].pageY - a.y;
      return [((n - l) / 2 + l) / (e / 100), ((o - s) / 2 + s) / (r / 100)];
    }, OrgChart._browser = function() {
      var t = !!window.opr && !!window.opr.addons || !!window.opera || navigator.userAgent.indexOf(" OPR/") >= 0, e = "undefined" != typeof InstallTrigger, r = /constructor/i.test(window.HTMLElement) || "[object SafariRemoteNotification]" === (!window.safari || void 0 !== window.safari && safari.pushNotification).toString(), i = !!document.documentMode, a = !i && !!window.StyleMedia, n = !(!window.chrome || !window.chrome.webstore && !window.chrome.runtime);
      return { opera: t, firefox: e, safari: r, msie: i, edge: a, chrome: n, blink: (n || t) && !!window.CSS };
    }, OrgChart._menuPosition = function(t, e, r) {
      var i = t.getBoundingClientRect(), a = r.getBoundingClientRect(), n = e.getBoundingClientRect(), o = i.left - a.left, l = i.top - a.top;
      ...
      return Array.from(e.body.childNodes).some((t2) => 1 === t2.nodeType);
      ...
      c || (c = "ellipsis");
      var u = c.split("-");
      if (u.length > 1 && (a = parseInt(c.split("-")[1]), u.length > 2 && "ellipsis" == u[2] && (n = true)), !d)
        return OrgChart._escapeHtml(t);
      if (d = parseFloat(d), l || (l = 0), s || (s = 0), l || (h = "start"), "ellipsis" == c) {
        ...
        for (var f = p.getComputedTextLength(), m = 2; f > d; )
          p.textContent = t.substring(0, t.length - m), p.textContent += "...", f = p.getComputedTextLength(), m++;
      ...
      if (-1 != c.indexOf("multiline")) {
        ...
        for (var x = 1, y = 1; y < C.length; y++) {
          ...
          if (O.firstChild.data += " " + C[y], O.getComputedTextLength() > d) {
      ...
      if (null != r && i.scaleLessThen) {
        ...
        if (n.length > 0) {
          n.sort(function(t2, e2) {
            return t2 - e2;
          });
          var s = i.scaleLessThen[n[0]];
          for (var h in s)
            null == a && (a = Object.assign({}, i)), a[h] = s[h];
        }
      }
      ...
      for (var o = 0; o < n; o++)
        !function() {
          var t2 = o, e2 = a[t2];
          OrgChart._getDataUri(e2.getAttribute(r), function(a2) {
            a2.success && e2.setAttribute(r, a2.result), t2 == n - 1 && i();
          });
        }();
      ...
      if (-1 != t.indexOf("base64"))
        ...
        r.open("GET", t), r.responseType = "blob", r.onload = function() {
          200 === r.status ? i.readAsDataURL(r.response) : 404 === r.status && e({ success: false, result: r.status });
        };
        var i = new FileReader();
        i.onloadend = function() {
          e({ success: true, result: i.result });
        }, r.send();
      }
      ...
      for (var e = [], r = function(t2) {
        for (var r2 = "", i2 = 0; i2 < e.length; i2++) {
          var a2;
          (a2 = "reportsTo" == e[i2] ? null : null == t2[e[i2]] ? "" : t2[e[i2]]) instanceof Date && (a2 = a2.toLocaleString());
          var n2 = (a2 = null === a2 ? "" : a2.toString()).replace(/"/g, '""'), o = new RegExp('("|;|\n)', "g");
          n2.search(o) >= 0 && (n2 = '"' + n2 + '"'), i2 > 0 && (r2 += OrgChart.CSV_DELIMITER), r2 += n2;
        }
        return r2 + "\n";
      }, i = "", a = 0; a < t.length; a++)
        for (var n in t[a])
          OrgChart._arrayContains(e, n) || (e.push(n), i += n + OrgChart.CSV_DELIMITER);
      i = i.substring(0, i.length - 1), i += "\n";
      for (a = 0; a < t.length; a++)
        i += r(t[a]);
      return i = i.substring(0, i.length - 1);
    }, OrgChart.accentFold = function(t) {
      return (t = t.toString().toLowerCase()).replace(/([àáâãäå])|([ç])|([èéêë])|([ìíîï])|([ñ])|([òóôõöø])|([ß])|([ùúûü])|([ÿ])|([æ])/g, function(t2, e, r, i, a, n, o, l, s, h, d) {
      ...
      if (t instanceof Date)
        ...
        e = t.constructor();
      for (var r in t)
        Object.prototype.hasOwnProperty.call(t, r) && (t.isActiveClone = null, e[r] = OrgChart.copy(t[r]), delete t.isActiveClone);
      return e;
    }, OrgChart._getScrollSensitivity = function() {
      var t = OrgChart._browser();
      return t.msie && OrgChart.scroll.ie ? OrgChart.scroll.ie : t.edge && OrgChart.scroll.edge ? OrgChart.scroll.edge : t.safari && OrgChart.scroll.safari ? OrgChart.scroll.safari : t.chrome && OrgChart.scroll.chrome ? OrgChart.scroll.chrome : t.firefox && OrgChart.scroll.firefox ? OrgChart.scroll.firefox : t.opera && OrgChart.scroll.opera ? OrgChart.scroll.opera : { smooth: OrgChart.scroll.smooth, speed: OrgChart.scroll.speed };
      ...
      function a(t2, e2, r2, i2) {
        ...
        return { x: t2 + r2 * Math.cos(a2), y: e2 + r2 * Math.sin(a2) };
      }
      function n(t2, e2, r2, i2, n2) {
        var o = a(t2, e2, r2, n2), l = a(t2, e2, r2, i2), s = n2 - i2 <= 180 ? "0" : "1";
        return ["M", o.x, o.y, "A", r2, r2, 0, s, 0, l.x, l.y].join(" ");
      }
      ...
      "function" == typeof IntersectionObserver ? new IntersectionObserver(function(t2, r) {
        t2.forEach(function(t3) {
          var r2 = t3.intersectionRatio > 0;
          0 == t3.intersectionRatio && (r2 = t3.isIntersecting), e(r2);
        });
      }).observe(t) : e(true);
      ...
      if ((this.config.mouseScrool == OrgChart.action.xScroll || this.config.mouseScrool == OrgChart.action.scroll) && this.bar) {
        ...
        !function(t2, r2, i) {
          ...
          function n() {
            a = true;
            var t3 = (e.pos - e.bar.scrollLeft) / i;
            if (t3 > 0)
              t3++;
            else {
              if (0 == t3)
            ...
            Math.ceil(e.bar.scrollLeft) == Math.ceil(e.pos) ? a = false : (e.bar.scrollLeft += t3, o(n));
          }
          t2.addEventListener("wheel", function(t3) {
            var i2 = 0;
            if (e.config.mouseScrool == OrgChart.action.xScroll)
              (i2 = t3.deltaX || t3.wheelDeltaX) || (i2 = t3.deltaY || t3.wheelDeltaY);
            else if (e.config.mouseScrool == OrgChart.action.scroll && !(i2 = t3.shiftKey ? t3.deltaY || t3.wheelDeltaY : t3.deltaX || t3.wheelDeltaX))
              return;
            i2 = -i2, i2 = Math.max(-1, Math.min(1, i2)), e.pos += -i2 * r2;
            var o2 = parseFloat(e.innerBar.clientWidth) - parseFloat(e.bar.clientWidth);
            e.pos < 0 && (e.pos = 0);
            e.pos > o2 && (e.pos = o2);
            a || n();
          }, { passive: true });
          var o = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function(t3) {
            setTimeout(t3, 20);
          };
        }(t, r.speed, r.smooth);
      }
      ...
      if (this.config.showXScroll === OrgChart.scroll.visible || this.config.mouseScrool === OrgChart.action.scroll || this.config.mouseScrool === OrgChart.action.xScroll) {
        ...
        this.requestParams();
        this.innerBar.innerHTML = "&nbsp", Object.assign(this.bar.style, { position: "absolute", left: 0, bottom: 0, width: t + "px", "overflow-x": "scroll", height: "20px" }), this.element.appendChild(this.bar), this.bar.appendChild(this.innerBar), this.bar.addEventListener("scroll", function() {
          if (this.ignore)
            this.ignore = false;
          else {
            var t2 = e.requestParams(), r = (parseFloat(e.innerBar.clientWidth) - parseFloat(e.bar.clientWidth)) / 100, i = this.scrollLeft / r, a = (t2.boundary.right - t2.boundary.left) / 100;
            t2.viewBox[0] = i * a + t2.boundary.left, e.onSetViewBoxCallback(t2.viewBox), clearTimeout(this._timeout), this._timeout = setTimeout(function() {
              e.onDrawCallback();
            }, 500);
          }
        });
      ...
      if (this.bar) {
        ...
        this.bar.ignore = true, this.bar.scrollLeft = n, this.pos = this.bar.scrollLeft, this.bar.style.visibility = a <= 0 ? "hidden" : "";
      }
      ...
      if (this.config.mouseScrool == OrgChart.action.yScroll || this.config.mouseScrool == OrgChart.action.scroll) {
        ...
        !function(t2, r2, i) {
          ...
          function n() {
            a = true;
            var t3 = (e.pos - e.bar.scrollTop) / i;
            if (t3 > 0)
              t3++;
            else {
              if (0 == t3)
            ...
            Math.ceil(e.bar.scrollTop) == Math.ceil(e.pos) ? a = false : (e.bar.scrollTop += t3, o(n));
          }
          t2.addEventListener("wheel", function(t3) {
            var i2 = 0;
            if (e.config.mouseScrool == OrgChart.action.yScroll)
              (i2 = t3.deltaY || t3.wheelDeltaY) || (i2 = t3.deltaX || t3.wheelDeltaX);
            else if (e.config.mouseScrool == OrgChart.action.scroll && !(i2 = t3.shiftKey ? t3.deltaX || t3.wheelDeltaX : t3.deltaY || t3.wheelDeltaY))
              return;
            i2 = -i2, i2 = Math.max(-1, Math.min(1, i2)), e.pos += -i2 * r2;
            var o2 = parseFloat(e.innerBar.clientHeight) - parseFloat(e.bar.clientHeight);
            e.pos < 0 && (e.pos = 0);
            e.pos > o2 && (e.pos = o2);
            a || n();
          }, { passive: true });
      ...
      if (this.config.showYScroll === OrgChart.scroll.visible || this.config.mouseScrool === OrgChart.action.scroll || this.config.mouseScrool === OrgChart.action.yScroll) {
        var e = this;
        this.bar && this.bar.parentNode.removeChild(this.bar), this.bar = document.createElement("div"), this.config.showYScroll !== OrgChart.scroll.visible && (this.bar.style.visibility = "hidden"), this.innerBar = document.createElement("div"), this.innerBar.innerHTML = "&nbsp", Object.assign(this.bar.style, { position: "absolute", right: 0, bottom: 0, height: t + "px", "overflow-y": "scroll", width: "20px" }), this.element.appendChild(this.bar), this.bar.appendChild(this.innerBar), this.bar.addEventListener("scroll", function() {
          if (this.ignore)
            this.ignore = false;
          else {
            var t2 = e.requestParams(), r = (parseFloat(e.innerBar.clientHeight) - parseFloat(e.bar.clientHeight)) / 100, i = this.scrollTop / r, a = (t2.boundary.bottom - t2.boundary.top) / 100;
            t2.viewBox[1] = i * a + t2.boundary.top, e.onSetViewBoxCallback(t2.viewBox), clearTimeout(this._timeout), this._timeout = setTimeout(function() {
              e.onDrawCallback();
            }, 500);
          }
        });
      ...
      if (this.bar) {
        ...
        this.bar.ignore = true, this.bar.scrollTop = n, this.pos = this.bar.scrollTop, this.bar.style.visibility = a <= 0 ? "hidden" : "";
      }
    }, OrgChart.prototype.zoom = function(t, e, r, i) {
      var a = this.getViewBox().slice(0), n = a, o = a[2], l = a[3];
      true === t ? (a[2] = a[2] / OrgChart.SCALE_FACTOR, a[3] = a[3] / OrgChart.SCALE_FACTOR) : false === t ? (a[2] = a[2] * OrgChart.SCALE_FACTOR, a[3] = a[3] * OrgChart.SCALE_FACTOR) : (a[2] = a[2] / t, a[3] = a[3] / t), e || (e = [50, 50]), a[0] = n[0] - (a[2] - o) / (100 / e[0]), a[1] = n[1] - (a[3] - l) / (100 / e[1]);
      var s = this.getScale(a);
      if (a[2] = this.width() / s, a[3] = this.height() / s, true === t && s < this.config.scaleMax || false === t && s > this.config.scaleMin || 0 != t && 1 != t && s < this.config.scaleMax && s > this.config.scaleMin) {
        ...
        r ? (clearTimeout(h._timeout), OrgChart.animate(this.getSvg(), { viewbox: this.getViewBox() }, { viewbox: a }, this.config.anim.duration, this.config.anim.func, function() {
          clearTimeout(h._timeout), h._timeout = setTimeout(function() {
            h._draw(true, OrgChart.action.zoom, null, i);
          }, 500);
      ...
      l.value = e.format, s.value = e.landscape, h.value = e.scale, d.value = e.margin, c.value = e.header, g.value = e.footer, OrgChart.animate(t.element.querySelector("#boc-ppdf-btns"), { margin: [0, 0, 0, -250] }, { margin: [0, 0, 0, 0] }, 300, OrgChart.anim.outSin, function() {
        ...
        clearTimeout(a), a = setTimeout(function() {
          OrgChart.animate(t.element.querySelector("#boc-ppdf-content"), { opacity: 1 }, { opacity: 0 }, 300, OrgChart.anim.inSin, function() {
            ...
            var r2 = d.value.split(",");
            if (4 == r2.length) {
              for (var i2 = 0; i2 < r2.length; i2++)
                r2[i2] = parseInt(r2[i2]);
              e.margin = r2, t.exportPDF(e, OrgChart.pdfPrevUI._handler);
            }
          });
        }, 1e3);
      ...
      for (var r, i, a, n, o, l = "", s = 0; s < this.config.clinks.length; s++) {
        let A2 = function(t2, e2, r2) {
          null == r2 && (r2 = 1);
          var i2 = e2.x - t2.x, a2 = e2.y - t2.y, n2 = Math.sqrt(Math.pow(e2.x - t2.x, 2) + Math.pow(e2.y - t2.y, 2)) / 3;
          return n2 = n2 / (Math.sqrt(i2 * i2 + a2 * a2) * r2) * OrgChart.CLINK_CURVE, { x: t2.x + i2 / 2 - a2 * n2, y: t2.y + a2 / 2 + i2 * n2 };
        };
        var A = A2;
        var h = this.config.clinks[s], d = t.getNode(h.from), c = t.getNode(h.to);
        if (d && -1 != e.res.visibleNodeIds.indexOf(d.id) && (c && -1 != e.res.visibleNodeIds.indexOf(c.id))) {
          var g = d.x, p = d.y, u = c.x, f = c.y, m = {}, C = {}, b = g + d.w / 2, O = u + c.w / 2, v = p + d.h / 2, x = f + c.h / 2, y = 1;
          switch (this.config.orientation) {
            case OrgChart.orientation.top:
            case OrgChart.orientation.top_left:
              b <= O ? (y = 1, m.x = b + d.w / 10, C.x = O - c.w / 10) : (y = -1, m.x = b - d.w / 10, C.x = O + c.w / 10), p == f ? (y = 1, m.y = p, C.y = f) : p > f ? (m.y = p, C.y = f + c.h) : (m.y = p + d.h, C.y = f);
              break;
            case OrgChart.orientation.bottom:
            case OrgChart.orientation.bottom_left:
              b <= O ? (y = -1, m.x = b + d.w / 10, C.x = O + c.w / 10) : (y = 1, m.x = b - d.w / 10, C.x = O + c.w / 10), p == f ? (y = -1, m.y = p + d.h, C.y = f + c.h) : p > f ? (m.y = p, C.y = f + c.h) : (m.y = p + d.h, C.y = f);
              break;
            case OrgChart.orientation.left:
            case OrgChart.orientation.left_top:
              v <= x ? (y = -1, m.y = v + d.h / 5, C.y = x + c.h / 5) : (y = 1, m.y = v - d.h / 5, C.y = x + c.h / 5), g == u ? (y = -1, m.x = g, C.x = u) : g > u ? (m.x = g, C.x = u + c.w) : (m.x = g + d.w, C.x = u);
              break;
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
              v <= x ? (y = 1, m.y = v + d.h / 5, C.y = x + c.h / 5) : (y = -1, m.y = v - d.h / 5, C.y = x + c.h / 5), g == u ? (y = 1, m.x = g + d.w, C.x = u + c.w) : g > u ? (m.x = g, C.x = u + c.w) : (m.x = g + d.w, C.x = u);
          }
          var _ = A2(m, C, y), w = h.template;
          w || (w = "orange");
          var k = OrgChart.clinkTemplates[w], S = (r = m, a = _, n = void 0, o = void 0, n = ((i = C).x - r.x) / 2 + r.x, o = (i.y - r.y) / 2 + r.y, { x: (n - a.x) / 2 + a.x, y: (o - a.y) / 2 + a.y });
      ...
      function n(e2, n2, o2) {
        var s2 = [], h2 = null, d = "left", c = e2.lcn ? e2.lcn : "base", g = t._layoutConfigs[c];
        switch (g.orientation) {
          ...
          case OrgChart.orientation.right:
          case OrgChart.orientation.right_top:
            d = "top", n2.y > e2.y && (d = "bottom");
        }
        var p = OrgChart.t(e2.templateName, e2.min, i), u = g.levelSeparation;
        (e2.parent && e2.parent.layout == OrgChart.mixed || e2.parent && e2.parent.layout == OrgChart.tree) && (u = g.mixedHierarchyNodesSeparation);
        var f = { p: e2.x + e2.w / 2 + p.expandCollapseSize, q: e2.y, r: e2.x + e2.w / 2 + p.expandCollapseSize, s: a.minY + u };
        if (e2.sl == n2.sl)
          switch (h2 = n2, g.orientation) {
            case OrgChart.orientation.top:
            case OrgChart.orientation.top_left:
              s2.push([f.p, f.q]), s2.push([f.p, f.q - u / 3]), p = OrgChart.t(h2.templateName, h2.min, i), s2.push([h2.x + h2.w / 2 + p.expandCollapseSize, s2[s2.length - 1][1]]), s2.push([s2[s2.length - 1][0], h2.y]);
              break;
            case OrgChart.orientation.bottom:
            case OrgChart.orientation.bottom_left:
              f.q = e2.y + e2.h, f.s = a.maxY - u, s2.push([f.p, f.q]), s2.push([f.r, e2.y + e2.h + u / 3]), p = OrgChart.t(h2.templateName, h2.min, i), s2.push([h2.x + h2.w / 2 + p.expandCollapseSize, s2[s2.length - 1][1]]), s2.push([s2[s2.length - 1][0], h2.y + h2.h]);
              break;
            case OrgChart.orientation.left:
            case OrgChart.orientation.left_top:
              f.p = e2.x, f.q = e2.y + e2.h / 2 + p.expandCollapseSize, f.r = a.minX - u, f.s = e2.y + e2.h / 2 + p.expandCollapseSize, s2.push([f.p, f.q]), s2.push([e2.x - u / 3, f.q]), p = OrgChart.t(h2.templateName, h2.min, i), s2.push([s2[s2.length - 1][0], h2.y + h2.h / 2 + p.expandCollapseSize]), s2.push([h2.x, s2[s2.length - 1][1]]);
              break;
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
              f.p = e2.x + e2.w, f.q = e2.y + e2.h / 2 + p.expandCollapseSize, f.r = a.maxX + u, f.s = e2.y + e2.h / 2 + p.expandCollapseSize, s2.push([f.p, f.q]), s2.push([e2.x + e2.w + u / 3, f.q]), p = OrgChart.t(h2.templateName, h2.min, i), s2.push([s2[s2.length - 1][0], h2.y + h2.h / 2 + p.expandCollapseSize]), s2.push([h2.x + h2.w, s2[s2.length - 1][1]]);
          }
        else {
          switch (g.orientation) {
            case OrgChart.orientation.top:
            case OrgChart.orientation.top_left:
              s2.push([f.p, f.q]), s2.push([f.r, e2.y - u / 3]);
              break;
            case OrgChart.orientation.bottom:
            case OrgChart.orientation.bottom_left:
              f.q = e2.y + e2.h, f.s = a.maxY - u, s2.push([f.p, f.q]), s2.push([f.r, e2.y + e2.h + u / 3]);
              break;
            case OrgChart.orientation.left:
            case OrgChart.orientation.left_top:
              f.p = e2.x, f.q = e2.y + e2.h / 2 + p.expandCollapseSize, f.r = a.minX - u, f.s = e2.y + e2.h / 2 + p.expandCollapseSize, s2.push([f.p, f.q]), s2.push([e2.x - u / 3, f.q]);
              break;
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
              f.p = e2.x + e2.w, f.q = e2.y + e2.h / 2 + p.expandCollapseSize, f.r = a.maxX + u, f.s = e2.y + e2.h / 2 + p.expandCollapseSize, s2.push([f.p, f.q]), s2.push([e2.x + e2.w + u / 3, f.q]);
          }
          for (var m = e2; null == h2; ) {
            var C = false, b = m.parent, O = b.leftNeighbor, v = b.rightNeighbor;
            if (b.id == n2.id ? h2 = b : OrgChart._intersects(b, f, t.config) && (f = OrgChart._addPoint(b, s2, t.config, f, d), C = true), b.id != n2.id) {
              for (; O; ) {
                if (O.id == n2.id) {
                  h2 = O;
                  break;
                }
                OrgChart._intersects(O, f, t.config) && (f = OrgChart._addPoint(O, s2, t.config, f, d), C = true), O = O.leftNeighbor;
              }
              for (; v; ) {
                if (v.id == n2.id) {
                  h2 = v;
                ...
                OrgChart._intersects(v, f, t.config) && (f = OrgChart._addPoint(v, s2, t.config, f, d), C = true), v = v.rightNeighbor;
              }
            }
            if (!C) {
              var x = s2[s2.length - 1][0], y = 0;
              if (b.parent)
                switch (u = g.levelSeparation, b.parent.layout != OrgChart.mixed && b.parent.layout != OrgChart.tree || (u = g.mixedHierarchyNodesSeparation), g.orientation) {
                  case OrgChart.orientation.top:
                  case OrgChart.orientation.top_left:
                  ...
                  case OrgChart.orientation.left:
                  case OrgChart.orientation.left_top:
                    x = b.parent.x + b.parent.w + u * (2 / 3), y = s2[s2.length - 1][1];
                    break;
                  case OrgChart.orientation.right:
                  case OrgChart.orientation.right_top:
                    x = b.parent.x - u * (2 / 3), y = s2[s2.length - 1][1];
                }
              s2.push([x, y]);
            }
            m = b;
          }
          switch (p = OrgChart.t(h2.templateName, h2.min, i), s2.splice(s2.length - 1, 1), g.orientation) {
            case OrgChart.orientation.top:
            case OrgChart.orientation.top_left:
              s2.push([h2.x + h2.w / 2 + p.expandCollapseSize, s2[s2.length - 1][1]]), s2.push([s2[s2.length - 1][0], h2.y + h2.h]);
              break;
            case OrgChart.orientation.bottom:
            case OrgChart.orientation.bottom_left:
              s2.push([h2.x + h2.w / 2 + p.expandCollapseSize, s2[s2.length - 1][1]]), s2.push([s2[s2.length - 1][0], h2.y]);
              break;
            case OrgChart.orientation.left:
            case OrgChart.orientation.left_top:
              s2.push([s2[s2.length - 1][0], h2.y + h2.h / 2 + p.expandCollapseSize]), s2.push([h2.x + h2.w, s2[s2.length - 1][1]]);
              break;
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
              s2.push([s2[s2.length - 1][0], h2.y + h2.h / 2 + p.expandCollapseSize]), s2.push([h2.x, s2[s2.length - 1][1]]);
          }
        }
        var _ = l.template;
        _ || (_ = "orange");
        ...
        switch ((p = OrgChart.slinkTemplates[_]).labelPosition) {
          case "start":
            ...
            break;
          case "middle":
            var I = Math.ceil(s2.length / 2);
            w = s2[I], k = s2[I - 1], S = { x: (w[0] + k[0]) / 2, y: (w[1] + k[1]) / 2 };
            break;
          case "end":
            S = { x: s2[s2.length - 2][0], y: s2[s2.length - 2][1] };
        }
        o2 && (s2 = s2.reverse()), s2[0] = "M" + s2[0].join(",");
        for (var A = 1; A < s2.length; A++)
          s2[A] = "L" + s2[A].join(",");
        var E = s2.join(" ");
        if (l.label) {
          var L = p.label.replace("{x}", S.x).replace("{y}", S.y).replace("{val}", l.label), N = OrgChart._getLabelSize(L), M = -N.height / 2;
          switch (g.orientation) {
            case OrgChart.orientation.bottom:
            case OrgChart.orientation.bottom_left:
              M = N.height;
          }
          r += p.label.replace("{x}", S.x).replace("{y}", S.y + M).replace("{val}", l.label);
        }
        var T = e2.id, B = n2.id;
        o2 && (T = n2.id, B = e2.id), r += ("<g " + OrgChart.attr.s_link_from + '="{from}" ' + OrgChart.attr.s_link_to + '="{to}">').replace("{from}", T).replace("{to}", B) + p.link.replaceAll("{d}", E) + '<path stroke="transparent" stroke-width="15" fill="none" d="' + E + '" />', r += OrgChart.grCloseTag;
      }
      for (var o = 0; o < this.config.slinks.length; o++) {
        var l = this.config.slinks[o], s = t.getNode(l.from), h = t.getNode(l.to);
        s && h && -1 != e.res.visibleNodeIds.indexOf(h.id) && -1 != e.res.visibleNodeIds.indexOf(s.id) && (s.sl >= h.sl ? n(s, h, false) : n(h, s, true));
      }
      e.content += r;
      ...
      if (t.config.groupDottedLines.length) {
        for (var r = t.element.querySelectorAll("[data-ctrl-n-dotted-close]"), i = 0; i < r.length; i++)
          r[i].addEventListener("click", function() {
            var e2 = this.getAttribute("data-ctrl-n-dotted-close");
            t.minimize(e2);
          });
        var a = t.element.querySelectorAll("[data-ctrl-n-dotted-open]");
        for (i = 0; i < a.length; i++)
          a[i].addEventListener("click", function() {
            var e2 = this.getAttribute("data-ctrl-n-dotted-open");
            t.maximize(e2);
          });
      }
    }), OrgChart.events.on("redraw", function(t, e) {
      if (t.config.miniMap && t.manager.action != OrgChart.action.move) {
        ...
        var i, a, n, o, l = t.element.querySelector('[data-id="mini-map-focus"]'), s = false, h = null;
        l.onmousedown = function(t2) {
          var e2, n2, o2, h2 = l.getBoundingClientRect(), d = h2.left, c = h2.top;
          if (i = parseInt(t2.clientX - d), a = parseInt(t2.clientY - c), e2 = a, n2 = (i - OrgChart.miniMap._settings._translateX) / OrgChart.miniMap._settings._scale, o2 = (e2 - OrgChart.miniMap._settings._translateY) / OrgChart.miniMap._settings._scale, n2 > r[0] && n2 < r[0] + r[2] && o2 > r[1] && o2 < r[1] + r[3])
            return t2.preventDefault(), t2.stopPropagation(), void (s = true);
        }, l.onmousemove = function(e2) {
          if (s) {
            e2.preventDefault(), e2.stopPropagation();
            var d = l.getBoundingClientRect(), c = d.left, g = d.top;
            n = parseInt(e2.clientX - c), o = parseInt(e2.clientY - g);
            var p = (n - i) / OrgChart.miniMap._settings._scale, u = (o - a) / OrgChart.miniMap._settings._scale;
            r[0] = p + r[0], r[1] = u + r[1], t.setViewBox(r), h && (clearTimeout(h), h = null), h = setTimeout(function() {
              t._draw(true, OrgChart.action.move);
            }, 300), OrgChart.miniMap._drawRectSelectorCanvas(t, r), i = n, a = o;
          }
        }, l.onmouseup = function(t2) {
          s && (t2.preventDefault(), t2.stopPropagation(), s = false);
        }, l.onmouseout = function(t2) {
          s && (t2.preventDefault(), t2.stopPropagation(), s = false);
        };
      }
    }), OrgChart.miniMap = {}, OrgChart.miniMap._settings = { _translateX: 0, _translateY: 0, _scale: 1 }, OrgChart.miniMap._drawMainCanvas = function(t) {
      ...
      !function t2(e2, n) {
        if (Array.isArray(n))
          ...
          for (o = 0; o < n.stChildrenIds.length; o++)
            i++, a.includes(n.id) || (1 == i ? r.fillStyle = OrgChart.miniMap.colors[0] : 2 == i ? r.fillStyle = OrgChart.miniMap.colors[1] : 3 == i && (r.fillStyle = OrgChart.miniMap.colors[2]), r.beginPath(), r.fillRect(n.x, n.y, n.w, n.h), r.strokeRect(n.x, n.y, n.w, n.h), a.push(n.id)), t2(e2, e2.getNode(n.stChildrenIds[o])), i--;
          for (o = 0; o < n.childrenIds.length; o++)
            t2(e2, e2.getNode(n.childrenIds[o]));
        }
      }(t, t.roots);
      ...
      if (!t.element.querySelector('[data-id="mini-map"]')) {
        ...
        var s = function(e2, r2) {
          t.__mouseScrollHandler(i, r2);
        };
        t._addEvent(i, "DOMMouseScroll", s), t._addEvent(i, "mousewheel", s);
        var h = 0, d = 0, c = function(t2) {
          var e2 = t2.clientX - h, r2 = t2.clientY - d;
          if (!OrgChart.isNEU(i.style.left)) {
            var a2 = parseFloat(i.style.left) + e2;
            i.style.left = `${a2}px`;
          }
          if (!OrgChart.isNEU(i.style.right)) {
            var n2 = parseFloat(i.style.right) - e2;
            i.style.right = `${n2}px`;
          }
          if (!OrgChart.isNEU(i.style.bottom)) {
            var o2 = parseFloat(i.style.bottom) - r2;
            i.style.bottom = `${o2}px`;
          }
          if (!OrgChart.isNEU(i.style.top)) {
            var l2 = parseFloat(i.style.top) + r2;
            i.style.top = `${l2}px`;
          }
          h = t2.clientX, d = t2.clientY;
        }, g = function() {
          document.removeEventListener("mousemove", c), document.removeEventListener("mouseup", g);
        };
        OrgChart.miniMap.draggable && i.addEventListener("mousedown", function(t2) {
          h = t2.clientX, d = t2.clientY, document.addEventListener("mousemove", c), document.addEventListener("mouseup", g);
        });
      }
    }, OrgChart.miniMap.colors = ["#E0E0E0", "#BDBDBD", "#9E9E9E", "#757575"], OrgChart.miniMap.selectorBackgroundColor = "white", OrgChart.miniMap.backgroundColor = "white", OrgChart.miniMap.focusStroke = "#f57c00", OrgChart.miniMap.opacity = 0.4, OrgChart.miniMap.border = "1px solid #aeaeae", OrgChart.miniMap.width = 250, OrgChart.miniMap.height = 140, OrgChart.miniMap.padding = 5, OrgChart.miniMap.position = { top: void 0, left: "padding", right: void 0, bottom: "padding" }, OrgChart.miniMap.draggable = true, OrgChart._search = {}, OrgChart._search.search = function(t, e, r, i, a, n, o) {
      var l = [], s = e.toLowerCase(), h = s.split(" ");
      if (o && h.length > 1) {
        var d = h[0];
        o[d] && (r = [o[d]], h = (s = s.replace(d, "").trim()).split(" "));
      }
      h = h.filter(function(t2, e2, r2) {
        return r2.indexOf(t2) === e2;
      });
          ...
          if (!OrgChart.isNEU(p[f])) {
            ...
            if (null != (e = OrgChart._search.searchAndComputeScore(h, m, f, n))) {
              ...
              if (c[C]) {
                ...
                c[C] = e.__score, OrgChart._search.addNodeToResult(l, i, p, e, f, a);
            }
          }
        }
      return l.sort(function(t2, e2) {
        return t2.__score < e2.__score ? 1 : t2.__score > e2.__score ? -1 : 0;
      }), l;
      ...
      n.sort(function(t2, e2) {
        return t2.start < e2.start ? -1 : t2.start > e2.start ? 1 : 0;
      });
      var O = e;
      for (p = n.length - 1; p >= 0; p--)
        O = (O = O.insert(n[p].start + n[p].length, "</mark>")).insert(n[p].start, "<mark>");
      ...
      return r.sort(function(t2, e2) {
        return t2.length < e2.length ? 1 : t2.length > e2.length || t2.start < e2.start ? -1 : t2.start > e2.start ? 1 : 0;
      }), r = r.filter(function(t2) {
        for (var e2 = false, i2 = 0; i2 < r.length; i2++) {
          var a2 = r[i2].start, n2 = r[i2].start + r[i2].length - 1, o = t2.start, l = t2.start + t2.length - 1;
          if (a2 == o && n2 == l) {
            e2 = false;
            break;
          }
      ...
      if (t.config.state) {
        ...
        !function t2(e2) {
          if (Array.isArray(e2))
            ...
            ("string" != typeof e2.id || "string" == typeof e2.id && -1 == e2.id.indexOf("split") && -1 == e2.id.indexOf("mirror")) && (r.push(e2.id), 1 == e2.min && i.push(e2.id));
            for (a = 0; a < e2.stChildren.length; a++)
              t2(e2.stChildren[a]);
            for (a = 0; a < e2.children.length; a++)
              t2(e2.children[a]);
          }
      ...
      if (l) {
        var s = OrgChart.state._buildStateNames(l.name), h = { roots: t, scale: Math.min(e / i[2], r / i[3]), x: i[0], y: i[1], exp: a, min: n, adjustify: o };
        ...
        l.writeToIndexedDB && (h.id = l.name, OrgChart.idb.put(h, function(t2) {
          0 == t2 && console.error("Cannot write row - " + l.name);
      ...
      if (t) {
        ...
        if (t.readFromUrlParams) {
          ...
          if (n.has(a.paramScale) && n.has(a.paramX) && n.has(a.paramY) && n.has(a.paramExp) && n.has(a.paramMin) && n.has(a.paramAdjustify)) {
            var o = {}, l = parseFloat(n.get(a.paramScale)), s = parseFloat(n.get(a.paramX)), h = parseFloat(n.get(a.paramY));
        ...
        if (t.readFromLocalStorage) {
          ...
          if (null != (o = OrgChart.localStorage.getItem(t.name)))
            return o = JSON.parse(o), (c = [])[0] = o.x, c[1] = o.y, c[2] = e / o.scale, c[3] = r / o.scale, o.vb = c, void i(o);
          if (!t.readFromIndexedDB)
            return void i(null);
        }
        t.readFromIndexedDB && OrgChart.idb.read(t.name, function(a2, n2) {
          if (0 == a2)
            console.error("Cannot read from - " + t.name), i(null);
          else if (null == a2)
            i(null);
          else {
            var o2 = [];
            o2[0] = n2.x, o2[1] = n2.y, o2[2] = e / n2.scale, o2[3] = r / n2.scale, n2.vb = o2, i(n2);
          }
        });
      } else
        i(null);
      ...
      if (n || o) {
        ...
        if (l && (null != l.timer && clearInterval(l.timer), null != l.timerBack && clearInterval(l.timerBack), o.setAttribute("transform", "matrix(" + l.transformStart.toString() + ")"), OrgChart._magnify[t] = null), r)
          o = o.cloneNode(true), this.getSvg().appendChild(o);
      ...
      if (i) {
        ...
        i.timerBack = OrgChart.animate(i.nodeElement, { transform: a }, { transform: i.transformStart }, e.duration, e.func, function(t2) {
          var e2 = t2[0].getAttribute(OrgChart.attr.node_id);
          OrgChart._magnify[e2] && OrgChart._magnify[e2].front && (t2[0].parentNode.removeChild(t2[0]), OrgChart._magnify[e2] = null), r && r(t2[0]);
        });
      }
      ...
      if (r) {
        ...
        if (false !== OrgChart.events.publish("key-down", [this, n]) && a) {
          if ("KeyF" == e.code)
            this.searchUI.find("");
      ...
      if (a.doNotRender)
        return { html: "" };
      var n = "";
      return e.btn && (n = `<a href="#" data-input-btn="" class="boc-link boc-link-boc-button">${e.btn}</a>`), { html: `<div class="boc-form-field" style="min-width: ${r};">
      ...
      return { html: `<div class="boc-form-field"  style="min-width: ${r};" >
      ...
      var a = OrgChart.elements._vidrf(t, e, i);
      return a.doNotRender ? { html: "" } : { html: `<div class="boc-form-field" style="min-width: ${r};">
                    <div class="boc-input" data-boc-input="" ${a.disabledAttribute} ${a.vlidators}>
                        <label for="${a.id}">${OrgChart._escapeGreaterLessSign(a.label)}</label>
                        <select data-binding="${OrgChart._escapeDoubleQuotes(a.binding)}" ${a.readOnlyAttribute} id="${a.id}" name="${a.id}">
                            ${function() {
        for (var t2 = "", e2 = 0; e2 < a.options.length; e2++) {
          var r2 = a.options[e2];
          t2 += `<option ${r2.value == a.value ? "selected" : ""} value="${OrgChart._escapeDoubleQuotes(r2.value)}">${OrgChart._escapeGreaterLessSign(r2.text)}</option>`;
        }
        return t2;
      }()}                           
                        </select>
      ...
      if (i.id = OrgChart.elements.generateId(), i.disabledAttribute = r ? "data-boc-input-disabled" : "", i.readOnlyAttribute = r ? "readonly" : "", i.id = i.id, r && OrgChart.isNEU(i.value) && (i.doNotRender = true), r && "photo" == e.binding && (i.id = null, i.doNotRender = true), i.binding = e.binding, i.label = e.label, i.vlidators = "", e.vlidators)
      ...
      for (var r = 0; r < e.length; r++) {
        ...
        n && (a.value || "select-one" == a.type && a.selectedOptions && a.selectedOptions.length && "" == a.selectedOptions[0].value && a.selectedOptions[0].innerHTML) && n.classList.add("hasval"), "checkbox" != a.type.toLowerCase() && a.addEventListener("focus", function() {
          ...
          var t2 = this.parentNode.querySelector("label");
          t2.classList.add("focused");
          var e2 = t2.querySelector(".boc-validation-error-message");
      ...
      var a = t.getAttribute("data-v-required"), n = t.getAttribute("data-v-password"), o = t.getAttribute("data-v-email"), l = t.getAttribute("data-v-emails");
      return a && "" == e.value ? (r.innerHTML += '<span class="boc-validation-error-message">&nbsp;' + a + "</span>", e.classList.add("boc-validation-error"), false) : n && !OrgChart.input.validatePassword(e.value) ? (r.innerHTML += '<span class="boc-validation-error-message">&nbsp;' + n + "</span>", e.classList.add("boc-validation-error"), false) : o && !OrgChart.input.isValidEmail(e.value) ? (r.innerHTML += '<span class="boc-validation-error-message">&nbsp;' + o + "</span>", e.classList.add("boc-validation-error"), false) : !(l && !OrgChart.input.isValidEmails(e.value)) || (r.innerHTML += '<span class="boc-validation-error-message">&nbsp;' + l + "</span>", e.classList.add("boc-validation-error"), false);
    }, OrgChart.input.validateAndGetData = function(t) {
      for (var e = t.querySelectorAll("[data-boc-input]"), r = true, i = 0; i < e.length; i++) {
        var a = e[i];
        OrgChart.input.validate(a) || (r = false);
      }
      if (!r)
        return false;
      ...
      if (this.instance.config.filterBy) {
        ...
        this.filterBy = t;
        var h = this, d = this.instance.element.querySelector("[data-filter]");
        d && d.parentNode.removeChild(d), (d = document.createElement("div")).setAttribute("data-filter", ""), d.style.position = "absolute", d.setAttribute("class", "boc-filter"), d.style.top = this.instance.config.padding + "px", d.style.left = this.instance.config.padding + "px";
        var c = "";
        for (var l in this.filterBy)
          c += `<div data-filter-field="${l}">${l}</div>`;
        d.innerHTML = `<div>${c}</div>`, d.addEventListener("click", function(t2) {
          if (t2.target.hasAttribute("data-filter-close") || t2.target.hasAttribute("data-filter-field")) {
            for (var e2 = t2.target.getAttribute("data-filter-field"), r2 = h.instance.element.querySelectorAll("[data-filter-menu]"), i2 = 0; i2 < r2.length; i2++)
              r2[i2].style.display = "none";
            var a2 = h.instance.element.querySelectorAll(".filter-field-selected");
            for (i2 = 0; i2 < a2.length; i2++)
              a2[i2].classList.remove("filter-field-selected");
            var n2 = h.instance.element.querySelector("[data-filter-close]");
            if (n2 && n2.parentNode.removeChild(n2), t2.target.hasAttribute("data-filter-close"))
              return;
            if (!t2.target.hasAttribute("data-filter-field"))
              return;
            var o2 = h.instance.element.querySelector(`[data-filter-menu="${e2}"]`);
            if (!o2) {
              var l2 = `<div>
                    <input data-all type="checkbox" id="${e2}" name="${e2}" checked>
                    <label for="${e2}">[All]</label>
                </div>`;
              for (var s2 in h.filterBy[e2]) {
                var d2 = h.filterBy[e2][s2], c2 = d2.text;
                null == c2 && (c2 = s2), l2 += `<div>
                        <input  type="checkbox" id="${s2}" name="${s2}" ${d2.checked ? "checked" : ""}>
                        <label for="${s2}">${c2}</label>
                    </div>`;
              }
              (o2 = document.createElement("div")).innerHTML = `<fieldset>
                                                    <legend>Filter by ${e2}:</legend>
                                                    ${l2}
                                                </fieldset>`, o2.setAttribute("data-filter-menu", e2), o2.classList.add("boc-filter-menu"), t2.target.parentNode.parentNode.appendChild(o2);
              var g = o2.querySelectorAll("input");
              for (i2 = 0; i2 < g.length; i2++)
                g[i2].addEventListener("change", function(t3) {
                  for (var e3 = t3.target; e3 && !e3.hasAttribute("data-filter-menu"); )
                    e3 = e3.parentNode;
                  if (e3) {
                    var r3 = e3.getAttribute("data-filter-menu");
                    if (t3.target.hasAttribute("data-all")) {
                      for (var i3 = t3.target.parentNode.parentNode.querySelectorAll("input"), a3 = 0; a3 < i3.length; a3++)
                        if (i3[a3] != t3.target)
                          for (var n3 in i3[a3].checked = t3.target.checked, h.filterBy[r3])
                            h.filterBy[r3][n3].checked = t3.target.checked;
                    } else
                      null != h.filterBy[r3][this.name] && (h.filterBy[r3][this.name].checked = this.checked);
                    h.instance.draw();
                  }
                });
            }
            o2.style.display = "block", t2.target.classList.add("filter-field-selected"), (n2 = document.createElement("div")).classList.add("close"), n2.innerHTML = "x", n2.setAttribute("data-filter-close", ""), t2.target.parentNode.appendChild(n2);
          }
        }), this.instance.element.appendChild(d);
      }
    }, void 0 === OrgChart && (OrgChart = {}), void 0 === OrgChart.remote && (OrgChart.remote = {}), OrgChart.LIMIT_NODES = true, OrgChart.remote._fromResDTO = function(t, e, r, i, a) {
      var n = e[t.id];
      ...
      var s = { n: a, c: o, r: n, v: "8.07.00" };
      if (OrgChart.LIMIT_NODES || (s.l = true), null != OrgChart.remote._fromReqDTO)
        OrgChart.remote._fromReqDTO(s.n, s.r, s.c, function(e2) {
          for (var a2 = 0; a2 < t.length; a2++)
            OrgChart.remote._fromResDTO(t[a2], e2, 0, t, i);
          r();
        });
      else {
        s = JSON.stringify(s);
        var h = OrgChart.localStorage.getItem(s);
        h && (h = JSON.parse(h)), h && !h.limit ? OrgChart.remote._proceed(t, h, i, r) : OrgChart.remote._findRegion(function(e2) {
          OrgChart._ajax(e2, "post", s, "json", function(e3) {
            e3.error ? r(2) : (OrgChart.remote._proceed(t, e3, i, r), OrgChart.localStorage.setItem(s, JSON.stringify(e3)));
          });
        });
      }
      ...
      if (e)
        ...
        for (a = 0; a < r.length; a++)
          !function() {
            var e2 = "https://" + r[a] + "-balkangraph.azurewebsites.net/api/OrgChartJS", n = i[a];
            n.onreadystatechange = function() {
              if (4 == this.readyState && 200 == this.status) {
                OrgChart.localStorage.setItem("funcUrl", e2), t(e2);
                for (var r2 = 0; r2 < i.length; r2++)
                  i[r2].abort();
              }
            }, n.open("GET", e2, true), n.send();
          }();
      }
    };
  }
...
// dep:@balkangraph_orgchart_js
var balkangraph_orgchart_js_default = require_orgchart();
export {
  balkangraph_orgchart_js_default as default
};
//# sourceMappingURL=@balkangraph_orgchart_js.js.map
