...
(function(dom) {
  ...
  let initSvgLoader = function svgLoader(init) {
    dom(`[data-loading-icon]`).each(function() {
      let color = dom(this).data("color") !== void 0 ? dom(this).data("color") : dom("body").css("color");
      let classAttr = dom(this).attr("class") !== void 0 ? dom(this).attr("class") : "";
      let icons = [
        {
          name: "audio",
          svg: `
...
//# sourceMappingURL=@left4code_tw-starter_dist_js_svg-loader.js.map
